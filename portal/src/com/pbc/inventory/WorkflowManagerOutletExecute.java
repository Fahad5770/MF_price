...
@WebServlet(description = "Workflow Manager Outlet Execute", urlPatterns = { "/inventory/WorkflowManagerOutletExecute" })

public class WorkflowManagerOutletExecute extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public WorkflowManagerOutletExecute() {
        super();
    }
