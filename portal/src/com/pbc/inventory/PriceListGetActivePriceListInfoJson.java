...
public class PriceListGetActivePriceListInfoJson extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			{
				System.out.println(
						"SELECT * FROM pep.inventory_price_list_regions ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.region_id="
								+ RegionID);
				rs = s.executeQuery(
						"SELECT * FROM pep.inventory_price_list_regions ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.region_id="
								+ RegionID);
			...
			{
				System.out.println(
						"SELECT * FROM inventory_price_list_channel ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.channel_id="
								+ DistributorGroupID);
				rs = s.executeQuery(
						"SELECT * FROM inventory_price_list_channel ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.channel_id="
								+ DistributorGroupID);
			...
			{
				System.out.println(
						"SELECT * FROM inventory_price_list_distributors ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.distributor_id="
								+ DistributorID);
				rs = s.executeQuery(
						"SELECT * FROM inventory_price_list_distributors ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.distributor_id="
								+ DistributorID);
			...
			{
				rs = s.executeQuery(
						"SELECT * FROM inventory_price_list_pjp ipr,inventory_price_list ipl where ipr.price_list_id=ipl.id and ipr.pjp_id="
								+ PJPID);
