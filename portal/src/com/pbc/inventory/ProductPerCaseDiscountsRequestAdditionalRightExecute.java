 ...
 */
@WebServlet(description = "User Additional Rights", urlPatterns = { "/inventory/ProductPerCaseDiscountsRequestAdditionalRightExecute" })
public class ProductPerCaseDiscountsRequestAdditionalRightExecute extends HttpServlet {
     ...
     */
    public ProductPerCaseDiscountsRequestAdditionalRightExecute() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Statement s = ds.createStatement();		
				...
				query = "delete from inventory_primary_percase_request_distributors where product_promotion_id = "+ProductPromotionsID;
				s.executeUpdate(query);
				...
				if(request.getParameterValues("DistributorIDhiddenfield") != null)
				{
					...
					for(int ii=0;ii<SelectedDistributor.length;ii++)
					{
						...
						query2 = "insert into " +
				                "inventory_primary_percase_request_distributors(product_promotion_id,distributor_id)" +
