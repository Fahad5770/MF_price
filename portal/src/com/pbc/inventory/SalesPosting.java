 ...
 public static boolean post(final long InvoiceID, final long UserID) {
     ...
     try {
         ...
         if (rs.first()) {
             ...
             s2.executeUpdate("replace into inventory_sales_adjusted (id, uvid, order_id, created_on, created_by, outlet_id, distributor_id, region_id, booked_by, type_id, sales_tax_amount, wh_tax_amount, adjusted_on, adjusted_by, beat_plan_id, brand_discount_amount,price_discount,extra_price_discount) values (" + InvoiceID + ", " + rs.getString("uvid") + ", " + rs.getString("order_id") + ", '" + rs.getString("created_on") + "', " + rs.getString("created_by") + ", " + rs.getString("outlet_id") + ", " + rs.getString("distributor_id") + ", " + rs.getString("region_id") + ", " + rs.getString("booked_by") + ", " + rs.getString("type_id") + "," + sales_tax_amount_f + ", " + wh_tax_amount_f + ", now(), " + UserID + ", " + rs.getString("beat_plan_id") + ", "+rs.getDouble("brand_discount_amount")+", "+rs.getDouble("price_discount")+", "+rs.getDouble("extra_price_discount")+" ) ");
         ...
         if (isValid) {
        	// System.out.println("delete from inventory_sales_adjusted_products where id = " + InvoiceID);
             ...
             while (rs2.next()) {
                 ...
                 int extra_price_discount_id = rs2.getInt("extra_price_discount_id");
                 double extra_price_discount = rs2.getDouble("extra_price_discount");
                 double extra_price_discount_amount = rs2.getDouble("extra_price_discount_amount");
                 int is_extra_percentage_discount = rs2.getInt("is_extra_percentage_discount");
                 int is_extra_with_tax_discount = rs2.getInt("is_extra_with_tax_discount");
                 ...
                 if (TotalUnits > 0) {
                     ...
                     final double sales_tax_rate = rs2.getDouble("sales_tax_rate");
                     ...
                     System.out.println("insert into inventory_sales_adjusted_products (id, product_id, raw_cases, units, total_units, liquid_in_ml, rate_raw_cases, rate_units, amount_raw_cases, amount_units, total_amount, price_discount_id, price_discount, price_discount_amount, is_percentage_discount, is_with_tax_discount, wh_tax_amount,sales_tax_rate,  sales_tax_amount, net_amount, is_promotion, promotion_id, hand_discount_rate, hand_discount_amount, hand_discount_id, cache_created_on_date, cache_distributor_id, cache_package_id, cache_brand_id, cache_order_id, cache_booked_by, cache_units_per_sku, cache_lrb_type_id, extra_price_discount_id, extra_price_discount, extra_price_discount_amount, is_extra_percentage_discount, is_extra_with_tax_discount) values (" + InvoiceID + ", " + ProductID + ", " + RawCases + ", " + Units + ", " + TotalUnits + ", " + LiquidinML + ", " + RateRawCase + ", " + RateUnit + ", " + AmountRawCases + ", " + AmountUnits + ", " + TotalAmount + ", "  + price_discount_id+ ", " + price_discount + ", " + price_discount_amount + ", " + is_percentage_discount + ", " + is_with_tax_discount+", " + wh_tax_amount +","+ sales_tax_rate + "," + sales_tax_amount + " ," + NetAmount + ", " + isPromotion + ", " + PromotionID + "," + HandDiscountRate + ", " + HandDiscountAmount + ", " + HandDiscountIDInsert + ", date('" + CreatedOnDate + "'), " + DistributorID + ", " + PackageID + ", " + BrandID + ", " + OrderID + ", " + BookedBy + "," + UnitsPerSKU + ", " + LRBTypeID + ", "  + extra_price_discount_id+ ", " + extra_price_discount + ", " + extra_price_discount_amount + ", " + is_extra_percentage_discount + ", " + is_extra_with_tax_discount+ ")  ");
                     s2.executeUpdate("insert into inventory_sales_adjusted_products (id, product_id, raw_cases, units, total_units, liquid_in_ml, rate_raw_cases, rate_units, amount_raw_cases, amount_units, total_amount, price_discount_id, price_discount, price_discount_amount, is_percentage_discount, is_with_tax_discount, wh_tax_amount,sales_tax_rate,  sales_tax_amount, net_amount, is_promotion, promotion_id, hand_discount_rate, hand_discount_amount, hand_discount_id, cache_created_on_date, cache_distributor_id, cache_package_id, cache_brand_id, cache_order_id, cache_booked_by, cache_units_per_sku, cache_lrb_type_id, extra_price_discount_id, extra_price_discount, extra_price_discount_amount, is_extra_percentage_discount, is_extra_with_tax_discount) values (" + InvoiceID + ", " + ProductID + ", " + RawCases + ", " + Units + ", " + TotalUnits + ", " + LiquidinML + ", " + RateRawCase + ", " + RateUnit + ", " + AmountRawCases + ", " + AmountUnits + ", " + TotalAmount + ", "  + price_discount_id+ ", " + price_discount + ", " + price_discount_amount + ", " + is_percentage_discount + ", " + is_with_tax_discount+", " + wh_tax_amount +","+ sales_tax_rate + "," + sales_tax_amount + " ," + NetAmount + ", " + isPromotion + ", " + PromotionID + "," + HandDiscountRate + ", " + HandDiscountAmount + ", " + HandDiscountIDInsert + ", date('" + CreatedOnDate + "'), " + DistributorID + ", " + PackageID + ", " + BrandID + ", " + OrderID + ", " + BookedBy + "," + UnitsPerSKU + ", " + LRBTypeID + ", "  + extra_price_discount_id+ ", " + extra_price_discount + ", " + extra_price_discount_amount + ", " + is_extra_percentage_discount + ", " + is_extra_with_tax_discount+ ")  ");
 ...
 public static boolean postOrder2Invoice(final long OrderID, final long UserID, final long UVID) {
     ...
     try {
         ...
         if (rs.first()) {
            ...
            System.out.println("insert into inventory_sales_invoices (uvid, order_id, created_on, created_by, outlet_id, distributor_id, region_id, booked_by, type_id, sales_tax_amount, wh_tax_amount, price_discount ,beat_plan_id, brand_discount_amount,extra_price_discount) values (" + UVID + ", " + OrderID + ", now(), " + UserID + ", " + rs.getString("outlet_id") + ", " + rs.getString("distributor_id") + ", " + rs.getString("region_id") + ", " + rs.getString("created_by") + ", 3," + sales_tax_amount + ", " + wh_tax_amount + "," + rs.getString("price_discount") + "," + rs.getString("beat_plan_id") + ", "+rs.getDouble("brand_discount_amount") +", "+rs.getDouble("extra_price_discount") + ")");
         ...
         if (isValid) {
             ...
             while (rs3.next()) {
                 ...
                 if (TotalUnits > 0) {
                     ...
                     double saleTaxRate = rs3.getDouble("sales_tax_rate");
                 ...
                 //    saleTax = ProductTax.get("income_tax") * (double)  RawCases;
                  //   wh_tax =  ProductTax.get("wh_tax") * (double)  RawCases;
                     ...
                     System.out.println("insert into inventory_sales_invoices_products (id, product_id, raw_cases, units, total_units, liquid_in_ml, rate_raw_cases, rate_units, amount_raw_cases, amount_units, total_amount, price_discount_id, price_discount, price_discount_amount, is_percentage_discount, is_with_tax_discount, wh_tax_amount,sales_tax_rate,sales_tax_amount,net_amount, is_promotion, promotion_id, hand_discount_rate, hand_discount_amount, hand_discount_id, salesTax, extra_price_discount_id, extra_price_discount, extra_price_discount_amount, is_extra_percentage_discount, is_extra_with_tax_discount) values (" + SaleInvoiceID + ", " + ProductID + ", " + RawCases + ", " + Units + ", " + TotalUnits + ", " + LiquidinML + ", " + RateRawCase + ", " + RateUnit + ", " + AmountRawCases + ", " + AmountUnits + ", " + TotalAmount + ", " + price_discount_id+ ", " + price_discount + ", " + price_discount_amount + ", " + is_percentage_discount + ", " + is_with_tax_discount+", " + wh_tax + " ," + saleTaxRate + "," + saleTax + "," + NetAmount + ", " + isPromotion + ", " + PromotionID + "," + HandDiscountRate + ", " + HandDiscountAmount + ", " + HandDiscountIDInsert + ", "+saleTax+", " + extra_price_discount_id+ ", " + extra_price_discount + ", " + extra_price_discount_amount + ", " + is_extra_percentage_discount + ", " + is_extra_with_tax_discount+")  ");
             ...
             try {
                ...
                System.out.println("SELECT * FROM mobile_order_unedited_products moup join inventory_products_view ipv on moup.product_id = ipv.product_id where moup.id = " + OrderID + " and moup.is_promotion = 0 and moup.is_processed = 0 and moup.product_id in (SELECT product_id FROM employee_product_groups_list where product_group_id in (select product_group_id from common_distributors where distributor_id = " + DistributorID + "))");
                 ...
                 while (rs3.next()) {
                     ...
                     final int extra_price_discount = rs3.getInt("extra_price_discount");
                     final double HandDiscountAmount = Utilities.parseDouble(Utilities.getDisplayCurrencyFormatSimple(HandDiscountRate * RawCases + HandDiscountRate / UnitsPerSKU * Units));
                     String HandDiscountIDInsert = "null";
                     if (HandDiscountID != 0L) {
                         HandDiscountIDInsert = new StringBuilder().append(HandDiscountID).toString();
