 ...
 */
@WebServlet(description = "Create PJP Excel File to Download", urlPatterns = { "/inventory/GetSalesExcelMain" })
public class GetSalesExcelMain extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			//if(!DistributorIDs.equals("")) {
				...
				String filename_Sales = "Sales_Detail_"+UserID+"_"+Utilities.getSQLDateWithoutSeprator(new java.util.Date())+".csv";
				
				//System.out.println("asdfasdf ");
				/*DO CHANGE THE FILE PATH FUNCTION BEFORE UPPING THE FILE */
				new com.pbc.inventory.GetSalesCSV().createPdf(Utilities.getCommonFilePath()+ "/" + filename_Sales, 0,StartDate,EndDate,DistributorIDs);
