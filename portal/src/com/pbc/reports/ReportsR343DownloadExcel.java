...
@WebServlet({ "/reports/ReportsR343DownloadExcel" })
public class ReportsR343DownloadExcel extends HttpServlet
{
    ...
    protected void service(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
     ...
     //   System.out.println("WhereRSM == " + WhereRSM);
        ...
        final String FileName = "ReportsR343_" + Utilities.getSQLDateWithoutSeprator(DateToday) + ".xlsx";
        final Datasource ds = new Datasource();
        try {
            final long Before = System.currentTimeMillis();
           System.out.println("RSMIDs - "+RSMIDs);
         
                new Report343UniqueProductivityShopsExcel().createExcel(String.valueOf(Utilities.getCommonFilePath()) + "/" + FileName, StartDate, EndDate, SessionUserID, RSMIDs, HODIDs);
