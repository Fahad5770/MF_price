...
@WebServlet({ "/reports/ReportsR340DownloadExcel" })
public class ReportsR340DownloadExcel extends HttpServlet
{
    ...
    protected void service(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
     ...
     //   System.out.println("WhereRSM == " + WhereRSM);
        ...
        final String FileName = "ReportsR340_" + Utilities.getSQLDateWithoutSeprator(DateToday) + ".xlsx";
        final Datasource ds = new Datasource();
        try {
            final long Before = System.currentTimeMillis();
           // System.out.println("Stock - "+isStock);
            if(isStock == 1) {
                new Report340DistributorSalesWithStockExcel().createExcel(String.valueOf(Utilities.getCommonFilePath()) + "/" + FileName, StartDate, EndDate, SessionUserID, WherePackage, DistributorIDs, WhereDistributors, SelectedDistributorsArray, WhereBrand);

            }else {
                new Report340DistributorSalesWithOutStockExcel().createExcel(String.valueOf(Utilities.getCommonFilePath()) + "/" + FileName, StartDate, EndDate, SessionUserID, WherePackage, DistributorIDs, WhereDistributors, SelectedDistributorsArray, WhereBrand);

            }
          //  new Report340DistributorSalesExcel().createExcel(String.valueOf(Utilities.getCommonFilePath()) + "/" + FileName, StartDate, EndDate, SessionUserID, WherePackage, DistributorIDs, WhereDistributors, SelectedDistributorsArray, WhereBrand);
