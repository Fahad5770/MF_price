...
@WebServlet(description = "Get Sales Order Status Json", urlPatterns = { "/sap/GetSalesOrderStatusJson" })

public class GetSalesOrderStatusJson extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetSalesOrderStatusJson() {
        super();
					...
					if (tab[0].getNumRows() > 0){
						...
						if(rows > 0 ){
							...
							while( rs2.next() ){
								...
								if (isPartial == true && isEditCase == false){
