...
public class CustomDestinationDataProvider
{
    ...
    static class MyDestinationDataProvider implements DestinationDataProvider
    {
        ...
        void changeProperties(String destName, Properties properties)
        {
            ...
            synchronized(secureDBStorage)
            {
                ...
                {
                	/*
                	File destCfg = new File("d://ABAP_AS.jcoDestination");
                    try
                    {
    ...
    static Properties getDestinationPropertiesFromUI()
    {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "temp");
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "pbcl123456");
