...
@WebServlet(description = "Get Order Info Json", urlPatterns = { "/sap/GetOrderInfoJson" })

public class GetOrderInfoJson extends HttpServlet {
		...
		try{
			...
			*/
			...
			if(isDuplicate == true){
				// 1: already exists
				JsonSuccess = false;
				JsonErrorMessage = "Already Exists";
			}else{
