...
@WebServlet(description = "Empty Credit Limit Request Approve", urlPatterns = { "/cash/GLEmptyCreditLimitApproveExecute" })

public class GLEmptyCreditLimitApproveExecute extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GLEmptyCreditLimitApproveExecute() {
        super();
    }
