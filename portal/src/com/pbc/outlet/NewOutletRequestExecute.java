...
@WebServlet(description = "Executes Outler Workflow Request", urlPatterns = { "/sampling/NewOutletRequestExecute" })
public class NewOutletRequestExecute extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public NewOutletRequestExecute() {
        super();
    }
