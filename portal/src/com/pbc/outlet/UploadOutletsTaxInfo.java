...
@WebServlet(description = "Uploads a file", urlPatterns = { "/outlet/UploadOutletsTaxInfo" })
public class UploadOutletsTaxInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public UploadOutletsTaxInfo() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Upload FileFor UploadOutletsTaxInfo");
							...
							for (int j = 0; j < strar.length; j++) {
								...
								if (i > 0) {
									...
									//	System.out.print(" geoFancing : "+geoFancing);
										...
										stn = strar[j];
										System.out.println("update common_outlets set is_filer="+is_filer+",is_register="+is_register+",ntn="+ntn+",stn="+stn+" where id="+outletId);
										s.executeUpdate("update common_outlets set is_filer="+is_filer+",is_register="+is_register+",ntn="+ntn+",stn="+stn+" where id="+outletId);
