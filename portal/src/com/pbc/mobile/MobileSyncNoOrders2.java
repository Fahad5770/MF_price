 ...
 */
@WebServlet(description = "Mobile Sync No Orders", urlPatterns = { "/mobile/MobileSyncNoOrders2" })
public class MobileSyncNoOrders2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MobileSyncNoOrders2() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!mr.isExpired()){
			...
			try{
				...
				s.executeUpdate("insert into mobile_order_zero (mobile_order_no, outlet_id, created_on, created_by, lat, lng, mobile_timestamp, is_no_order, no_order_reason_type) values "+
						"("+NoOrderID+", "+OutletID+", now(), "+MobileUserID+", "+Lat+", "+Lng+", '"+MobileTimestamp+"', 1, "+ReasonID+" ) ");
