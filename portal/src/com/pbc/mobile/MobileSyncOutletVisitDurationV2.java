...
@WebServlet(description = "Mobile Sync Outlet Visit Duration", urlPatterns = {
		"/mobile/MobileSyncOutletVisitDurationV2" })
public class MobileSyncOutletVisitDurationV2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MobileSyncOutletVisitDurationV2() {
		super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!mr.isExpired()) {
				...
				final double distance_from_store = Utilities.parseDouble(mr.getParameter("distance_from_store"));
				...
				try {
					...
					String args = MobileRequestID + ", '" + MobileTimestamp + "', " + OutletID + ", now(), "
							...
							+ ", " + city_id + ","+distance_from_store+", '" + Platform + "', '" + AppVersion+"'";
//					System.out.println(
