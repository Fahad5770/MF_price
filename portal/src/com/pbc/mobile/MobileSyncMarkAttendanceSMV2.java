 ...
 */
@WebServlet(description = "Mobile Sync Mark Attendance V2", urlPatterns = { "/mobile/MobileSyncMarkAttendanceSMV2" })
public class MobileSyncMarkAttendanceSMV2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MobileSyncMarkAttendanceSMV2() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("MobileSyncMarkAttendanceSMV2");
		...
		if (!mr.isExpired()){
			...
			ResultSet rs2 = s3.executeQuery("SELECT distinct distributor_id FROM distributor_beat_plan_view where asm_id="+MobileUserID);
			if(rs2.first()) {
			...
			//System.out.println("DistributorID"+DistributorID);
				...
				if(MobileUserID==204200003 || MobileUserID==204180013) {//Patch Added by Zulqurnan for Some exceptional cases on request of Sharukh Shb - 13/02/2020
					Flag=1;
				}
