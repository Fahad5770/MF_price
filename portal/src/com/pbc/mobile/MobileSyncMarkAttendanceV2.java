 ...
 */
@WebServlet(description = "Mobile Sync Mark Attendance", urlPatterns = { "/mobile/MobileSyncMarkAttendanceV2" })
public class MobileSyncMarkAttendanceV2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MobileSyncMarkAttendanceV2() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("MobileSyncMarkAttendanceV2");
