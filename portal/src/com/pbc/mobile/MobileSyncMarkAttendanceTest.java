 ...
 */
@WebServlet(description = "Mobile Sync Mark Attendance", urlPatterns = { "/mobile/MobileSyncMarkAttendanceTest" })
public class MobileSyncMarkAttendanceTest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MobileSyncMarkAttendanceTest() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("MobileSyncMarkAttendanceTest");
		...
		if (!mr.isExpired()){
			...
			System.out.println("SELECT * FROM common_distributor_location where distributor_id="+DistributorID);
				...
				while(rs.next() && counter==0 /*&& (DistributorID==2643)*/) {
					...
					if(DistributorID==3354) { //for Lahroe Distributor Sharukh shb marked radius to 500 - 10/04/2020
						Radius=500;
					}
