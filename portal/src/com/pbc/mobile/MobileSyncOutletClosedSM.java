 ...
 */
@WebServlet(description = "Mobile Sync Outlet Closed", urlPatterns = { "/mobile/MobileSyncOutletClosedSM" })
public class MobileSyncOutletClosedSM extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MobileSyncOutletClosedSM() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("MobileSyncOutletClosedSM - ");
		...
		if (!mr.isExpired()){
			...
			try{
				...
				System.out.println("insert into mobile_outlet_sm_closed (mobile_order_no, outlet_id, created_on, created_by, lat, lng, mobile_timestamp,distributor_id) values "+
						"("+NoOrderID+", "+OutletID+", now(), "+MobileUserID+", "+Lat+", "+Lng+", '"+MobileTimestamp+"',"+DistributorID+")");
				
				s.executeUpdate("insert into mobile_outlet_sm_closed (mobile_order_no, outlet_id, created_on, created_by, lat, lng, mobile_timestamp,distributor_id) values "+
						"("+NoOrderID+", "+OutletID+", now(), "+MobileUserID+", "+Lat+", "+Lng+", '"+MobileTimestamp+"',"+DistributorID+")");
