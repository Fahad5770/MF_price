...
@WebServlet(description = "", urlPatterns = { "/mobile/BankAlflahMoneyTransactionExecute_2" })
public class BankAlflahMoneyTransaction_2 extends HttpServlet { 
	private static final long serialVersionUID = 1L;
       
    public BankAlflahMoneyTransaction_2() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		if (!mr.isExpired()){
			...
			String TransactionRefNum =Utilities.filterString(mr.getParameter("TRefNumb"),1,100);//mr.getParameter("MobileNo");
		...
		String credientialsString="KEY_TRANSACTION_REF="+TransactionRefNum+"&&KEY_AMOUNT="+Amount+"&&KEY_FROM_ACCOUNT="+AccountFrom+"&&KEY_TO_ACCOUNT="+AccountTo+"&&KEY_CHANNEL=sd_weblite&&KEY_TRAN_TYPE=Deposit&&KEY_CHANNEL_MOBILE="+MobileNo+"&&KEY_TO_WALLET=123123131&&KEY_CHANNEL_PIN=1111&&KEY_CHANNEL_USERNAME=&&OTP_VAL_FLAG=Y&&OTP="+PinCode;
		...
		System.out.println(credientialsString);
