     ...
     try {
         ...
         if (isValid) {
             ...
             while (rs3.next()) {
                 ...
                 final double ProductDiscount = rs3.getDouble("discount");
                 ...
                 if (TotalUnits > 0) {
                     ...
                     s2.executeUpdate("insert into inventory_sales_invoices_products (id, product_id, raw_cases, units, total_units, liquid_in_ml, rate_raw_cases, rate_units, amount_raw_cases, amount_units, total_amount, discount, wh_tax_amount, net_amount, is_promotion, promotion_id, hand_discount_rate, hand_discount_amount, hand_discount_id) values (" + SaleInvoiceID + ", " + ProductID + ", " + RawCases + ", " + Units + ", " + TotalUnits + ", " + LiquidinML + ", " + RateRawCase + ", " + RateUnit + ", " + AmountRawCases + ", " + AmountUnits + ", " + TotalAmount + ", " + ProductDiscount + ", " + WHTaxAmount + " ," + NetAmount + ", " + isPromotion + ", " + PromotionID + "," + HandDiscountRate + ", " + HandDiscountAmount + ", " + HandDiscountIDInsert + ")  ");
                 }
             }
             InvoiceAmount = Utilities.parseDouble(Utilities.getDisplayCurrencyFormatSimple(InvoiceAmount));
             InvoiceWHTaxAmount = Utilities.parseDouble(Utilities.getDisplayCurrencyFormatSimple(InvoiceWHTaxAmount));
         ...
         while (rs1.next()) {
             try {
                 ...
                 while (rs3.next()) {
                     ...
                     s3.executeUpdate("insert into mobile_order_products (id, product_id, raw_cases, units, total_units, liquid_in_ml, rate_raw_cases, rate_units, amount_raw_cases, amount_units, total_amount, wh_tax_amount, net_amount, is_promotion, promotion_id, hand_discount_rate, hand_discount_amount, hand_discount_id) values (" + SplitOrderID + ", " + ProductID + ", " + RawCases + ", " + Units + ", " + TotalUnits + ", " + LiquidinML + ", " + RateRawCase + ", " + RateUnit + ", " + AmountRawCases + ", " + AmountUnits + ", " + TotalAmount + ", " + WHTaxAmount + "," + NetAmount + ", 0, " + PromotionID + "," + HandDiscountRate + ", " + HandDiscountAmount + ", " + HandDiscountIDInsert + ")  ");
