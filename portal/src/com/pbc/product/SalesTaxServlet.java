...
@WebServlet("/product/SalesTaxServlet")
public class SalesTaxServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            s.executeUpdate("UPDATE inventory_sales_tax SET isActive = 0");

            String query =
                "INSERT INTO inventory_sales_tax(FR,FUR,NFR,NFUR,created_on,created_by,isActive) VALUES(" +
