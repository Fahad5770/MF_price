...
public class OBLoginResponse {
	...
	private JSONArray ExtraGlobalpriceDiscount = new JSONArray();
	private JSONArray ExtraActivepriceDiscount = new JSONArray();
	private JSONArray ExtraPriceDiscountRegion = new JSONArray();
	private JSONArray ExtraPriceDiscountDistribution = new JSONArray();
	private JSONArray ExtraPriceDiscountChannel = new JSONArray();
	...
	public JSONArray getExtraGlobalpriceDiscount() {
		return ExtraGlobalpriceDiscount;
	}

	public void setExtraGlobalpriceDiscount(JSONArray extraGlobalpriceDiscount) {
		ExtraGlobalpriceDiscount = extraGlobalpriceDiscount;
	}

	public JSONArray getExtraActivepriceDiscount() {
		return ExtraActivepriceDiscount;
	}

	public void setExtraActivepriceDiscount(JSONArray extraActivepriceDiscount) {
		ExtraActivepriceDiscount = extraActivepriceDiscount;
	}

	

	public JSONArray getExtraPriceDiscountRegion() {
		return ExtraPriceDiscountRegion;
	}

	public void setExtraPriceDiscountRegion(JSONArray extraPriceDiscountRegion) {
		ExtraPriceDiscountRegion = extraPriceDiscountRegion;
	}

	public JSONArray getExtraPriceDiscountDistribution() {
		return ExtraPriceDiscountDistribution;
	}

	public void setExtraPriceDiscountDistribution(JSONArray extraPriceDiscountDistribution) {
		ExtraPriceDiscountDistribution = extraPriceDiscountDistribution;
	}

	public JSONArray getExtraPriceDiscountChannel() {
		return ExtraPriceDiscountChannel;
	}

	public void setExtraPriceDiscountChannel(JSONArray extraPriceDiscountChannel) {
		ExtraPriceDiscountChannel = extraPriceDiscountChannel;
	}
	...
	public LinkedHashMap<String, Object> getIntoJson() {
		...
		dataObject.put("extra_global_price_discount", this.ExtraGlobalpriceDiscount);
		dataObject.put("extra_active_price_discount", this.ExtraActivepriceDiscount);
		dataObject.put("extra_price_discount_region", this.ExtraPriceDiscountRegion);
		dataObject.put("extra_price_discount_distribution", this.ExtraPriceDiscountDistribution);
		dataObject.put("extra_price_discount_channel", this.ExtraPriceDiscountChannel);
