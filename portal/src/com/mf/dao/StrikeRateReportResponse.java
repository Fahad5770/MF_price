...
public class StrikeRateReportResponse {

	private String orderDate;
	private String zone;
	private String area;
	private String grantTotal;
	private List<OutletStrikeReport> outletOrdersReport;

	public StrikeRateReportResponse() {

	}

	public StrikeRateReportResponse( String orderDate, String zone, String area) {
	...
	public List<OutletStrikeReport> getOrder() {
		return this.outletOrdersReport;
	}

	public void setOrder(List<OutletStrikeReport> outletOrdersReport) {
	...
	public LinkedHashMap<String, Object> getIntoJson() {
		...
		for (OutletStrikeReport outletOrdersReport : this.outletOrdersReport) {
