					...
					while(rs.next()){
						...
						while(rs2.next()){
							...
							<tr>
		    					...
		    					<td style="text-align:right; padding-right:10px; border-left: 1px solid #ececec; border-right: 1px solid #ececec"><%=Utilities.convertToRawCases(OpeningUnits, UnitPerSKU) %></td>
		    					...
		    					<td style="text-align:right; padding-right:10px; border-left: 1px solid #ececec; border-right: 1px solid #ececec"><%=Utilities.convertToRawCases(ClosingUnits, UnitPerSKU)%></td>
