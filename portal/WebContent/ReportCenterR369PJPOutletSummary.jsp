						...
						<thead>
							<tr style="font-size: 11px;">
								...
								<th data-priority="1" style="text-align: center; width: 10%">Created
									On</th>
								<th data-priority="1" style="text-align: center; width: 10%">CNIC</th>
							</tr>
