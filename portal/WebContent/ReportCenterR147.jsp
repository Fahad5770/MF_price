		...
		<td style="width: 100%" valign="top">
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					<tbody>
						...
						ResultSet rs2 = s.executeQuery("Select sum(debit), sum(credit) FROM gl_transactions_accounts glta join gl_transactions glt  on glta.id=glt.id where 1=1 "+WhereCashInstruments+" and document_date < "+Utilities.getSQLDate(StartDate));
						if(rs2.first()){
						...
						ResultSet rs1 = s.executeQuery("Select *   FROM gl_transactions_accounts glta join gl_transactions glt  on glta.id=glt.id where 1=1 "+WhereCashInstruments+" and document_date between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDate(EndDate)+" order by document_date, glt.id");
