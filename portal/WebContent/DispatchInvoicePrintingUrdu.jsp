		  ...
		  while (rs.next()){
              ...
              <table border="0" style="width:100%">
                ...
                <tr>
			  	...
			  	<hr />
			  	<table style="width: 100%;  margin: 10px; padding-right: 15px; font-size: 12px" border="0">
			  		
			  		
			  		<tr>
				  		<td style="width: 50%; direction:rtl;"><b>Outlet</b></td>
				  		<td style="width: 50%; direction:rtl;"><b>Owner</b></td>
				  	</tr>
				  	<tr>
				  		<td style="font-size: 12pt; font-family: Tahoma; direction:rtl;"><%= OutletID + " - " + dic.translateToUrdu(OutletName) %></td>
				  		<td style="font-size: 12pt; font-family: Tahoma; direction:rtl;"><%= dic.translateToUrdu(Owner) %></td>
			  		</tr>
			  		<tr>
				  		<td style="direction:rtl;"><b>Address</b></td>
				  		<td style="direction:rtl;"><b>Contact No</b></td>
				  	</tr>
				  	<tr>
				  		<td style="font-size: 12pt; font-family: Tahoma; direction:rtl;"><%= dic.translateToUrdu(OutletAddress) %></td>
				  		<td style="direction:rtl;"><%= Telephone %></td>
			  		</tr>
			  		
			  		
			  		<tr>
							<td><b>Distributor</b></td>
							<td style="font-size: 9pt; font-family: Tahoma; direction:rtl;"><b>NTN</b></td>
						</tr>
						<tr>
							<td><%=DistributorID + " - " + DistributorName%></td>
							<td style="font-size: 12pt; font-family: Tahoma; direction:rtl;"> <%= (NTN != null && !NTN.trim().isEmpty()) ? NTN : "" %></td>
						</tr>
						<tr>
							<td><b>STRN</b></td>
						</tr>
			  	...
			  	<table style="width: 100%;  padding-left: 10px;padding-right: 10px; font-size: 12px" border="0" cellpadding="0" cellspacing="0">
			  		<tr style="font-weight: 700; font-size:12px">
			  			...
			  			<td class="formattedRow" nowrap style="text-align: right;">Discount</td>						
						<td class="formattedRow" nowrap style="text-align: right;">Net Amount</td>
			  		</tr>
			  	<%
				...
				//System.out.println(ArrayData[0]+" - "+RateRawCaseBase);
			  	...
			  	%>
			  		<tr>
			  			...
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%if(DiscountValue!=0){%><%= Utilities.getDisplayCurrencyFormat(DiscountValue)%><%}else{ %><%} %></td> <%-- NetAmount --%>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.getDisplayCurrencyFormat(NetAmount)%></td> <%-- NetAmount --%>
			  	...
			  	<%
						...
						<tr>
			  			...
			  			<td class="formattedRow"><%= Brand %></td>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.convertToRawCases(TotalUnits, UnitPerSKU) %></td>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.getDisplayCurrencyFormat(Rate)%></td> <%-- Rate --%>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.getDisplayCurrencyFormat(NetAmount)%></td> <%-- NetAmount --%>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"></td> <%-- NetAmount --%>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.getDisplayCurrencyFormat(NetAmount)%></td> <%-- NetAmount --%>
				...
				Discount = Discount-TotalAmountHandDisc;
			  	%>
			  		...
			  		<tr>
			  			<td colspan="7" style="text-align:right; padding-right:5px">Grand Total:</td>
			  			<td style="text-align:right; padding-right:5px;"><%=Utilities.getDisplayCurrencyFormat(TotalAmountBase)%></td>
			  		</tr>
			  		<tr>
			  			<td colspan="7" style="text-align:right; padding-right:5px">Advance Tax U/S 236H :</td>
			  		...
			  		<tr>
			  			<td colspan="7" style="text-align:right; padding-right:5px"><b>Net Amount:</b></td>
