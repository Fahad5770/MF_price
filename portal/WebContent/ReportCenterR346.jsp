...
//System.out.println(OutletIds);

WhereDistributors = WhereSelectedDistributors+WhereSelectedSNDDistributors+WhereSelectedRSMDistributors;
...
function ExportToExcel(D1,D2,DistIDs,outletIds){
	//alert(D1);
	$.mobile.showPageLoadingMsg();	
	
	$.ajax({
		
		url: "reports/R346ExcelMain",
		data: {
			StartDate: D1,
			EndDate:D2,
							...
							<tr>
								<td style="text-align: center">
   									...
   									<div id="aExcelFileReady">
   										<a onclick="ExportToExcel(<%=Utilities.getSQLDate(StartDate) %>,<%=Utilities.getSQLDateNext(EndDate) %>,'<%=DistributorIDs %>','<%=OutletIds %>')" href="#"    data-theme="c" data-inline="true" style="margin-top: 0px; margin-left: 0px; margin-bottom: 0px">Export To Excel</a>
   								</div>
