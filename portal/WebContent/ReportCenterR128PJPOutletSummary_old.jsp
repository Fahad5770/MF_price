							...
							<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
									 <thead>
									    <tr style="font-size: 11px;">
											...
											<th data-priority="1"  style="text-align:center; width: 10%" >Created On</th>
									    </tr>
								...
								while(rs.next()){
									...
									if(OutletDays.contains("Mon")){ MonOutletCount++; }
									if(OutletDays.contains("Tue")){ TueOutletCount++; }
									if(OutletDays.contains("Wed")){ WedOutletCount++; }
									if(OutletDays.contains("Thu")){ ThuOutletCount++; }
									if(OutletDays.contains("Fri")){ FriOutletCount++; }
									if(OutletDays.contains("Sat")){ SatOutletCount++; }
									if(OutletDays.contains("Sun")){ SunOutletCount++; }
									
									
									//Frequencey count
									
									if(counter==1){ F1OutletCount++; }
									if(counter==2){ F2OutletCount++; }
									if(counter==3){ F3OutletCount++; }
									if(counter==4){ F4OutletCount++; }
									if(counter==5){ F5OutletCount++; }
									if(counter==6){ F6OutletCount++; }
									if(counter==7){ F7OutletCount++; }
								...
								%>
										<tr style="font-size: 10px;">
											<td><%=rs.getString("assigned_to") + " - "+ rs.getString("assigned_to_name") %></td>
					   	            		...
					   	            		<td><%if(rs.getString("channel_label") != null){%><%= rs.getString("channel_label") %><% } %></td>
								...
								int TotalOutletCount = MonOutletCount+TueOutletCount+WedOutletCount+ThuOutletCount+FriOutletCount+SatOutletCount+SunOutletCount;
								int FTotalOutletCount = F1OutletCount+F2OutletCount+F3OutletCount+F4OutletCount+F5OutletCount+F6OutletCount+F7OutletCount;
				...
				<table style="width: 100%; " cellpadding="0" cellspacing="0">
					<tr >
						<td style="width: 50%" valign="top">
							<table border=0 style="font-size:13px; font-weight: 400; width:90%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
								<tr style="font-size: 10px;">
									<th>Day</th>
								...
								<tr style="font-size: 10px;">
									<td>Monday</td>
									<td style="text-align:center;"><%if(MonOutletCount!=0){%><%=MonOutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>Tuesday</td>
									<td style="text-align:center;"><%if(TueOutletCount!=0){%><%=TueOutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>Wednesday</td>
									<td style="text-align:center;"><%if(WedOutletCount!=0){%><%=WedOutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>Thursday</td>
									<td style="text-align:center;"><%if(ThuOutletCount!=0){%><%=ThuOutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>Friday</td>
									<td style="text-align:center;"><%if(FriOutletCount!=0){%><%=FriOutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>Saturday</td>
									<td style="text-align:center;"><%if(SatOutletCount!=0){%><%=SatOutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>Sunday</td>
									<td style="text-align:center;"><%if(SunOutletCount!=0){%><%=SunOutletCount %><%} %></td>
								</tr>	
								<tr style="font-size: 10px;">
									<td><b>Total Calls</b></td>
									<td style="text-align:center;"><b><%if(TotalOutletCount!=0){%><%=TotalOutletCount %><%} %></b></td>
								</tr>		
							</table>
						</td>
						<td style="width: 50%" valign="top">
							<table border=0 style="font-size:13px; font-weight: 400; width:90%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
								...
								<tr style="font-size: 10px;">
									<td>1</td>
									<td style="text-align:center;"><%if(F1OutletCount!=0){%><%=F1OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>2</td>
									<td style="text-align:center;"><%if(F2OutletCount!=0){%><%=F2OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>3</td>
									<td style="text-align:center;"><%if(F3OutletCount!=0){%><%=F3OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>4</td>
									<td style="text-align:center;"><%if(F4OutletCount!=0){%><%=F4OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>5</td>
									<td style="text-align:center;"><%if(F5OutletCount!=0){%><%=F5OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>6</td>
									<td style="text-align:center;"><%if(F6OutletCount!=0){%><%=F6OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td>7</td>
									<td style="text-align:center;"><%if(F7OutletCount!=0){%><%=F7OutletCount %><%} %></td>
								</tr>
								<tr style="font-size: 10px;">
									<td><b>Total Outlets</b></td>
									<td style="text-align:center;"><b><%if(FTotalOutletCount!=0){%><%=FTotalOutletCount %><%} %></b></td>
								</tr>			
							</table>
						</td>
					</tr>
