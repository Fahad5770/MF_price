...
function ReportCenterR167LoadScopeList(ParamDocumentID){
	...
	function ReportCenterR174ConsumerList(ParamDocumentID){
		
		$('#ReportCenterR174LoadConsumerList').html( "<img src='images/snake-loader.gif' >" );
		
		$.ajax({
		    url: "ReportCenterR174LoadConsumerList.jsp",
		    data: {
		    	DocumentID: ParamDocumentID
		    },
		    type: "POST",
		    ...
		    success: function( html ) {
		    	//alert(html);
		    	$('#ReportCenterR174LoadConsumerList').html( html ).trigger('create');
		    },
		    error: function( xhr, status ) {
		    	alert("Server could not be reached.");
		    }
				...
				System.out.println(rs.getString("request_id"));
					...
					%>
						<tr>
							...
							<td><a href="#popupDialogReportCenterR174ConsumerList" data-rel="popup" data-position-to="window" data-transition="pop" onclick="ReportCenterR174ConsumerList(<%=rs.getString("request_id")%>)" >View</a></td>
