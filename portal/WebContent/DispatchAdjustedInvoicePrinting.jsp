		  ...
		  while (rs.next()){
              ...
              <table border="0" style="width:100%">
              	<tr>
                    ...
                    <td style="text-align: right; font-weight: 700; padding-right:10px">SALE INVOICE<br><span style="font-weight: normal; font-size: 10px">(Adjusted)</span></td>
			...
			////////Updated patch by Zulqurnan on 26/10/2017 - for price list rates
			  	...
			  	%>
			  		<tr>
			  			...
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.getDisplayCurrencyFormat(Rate)%></td>
			  			<td class="formattedRow" style="text-align: right; padding-right:5px;"><%= Utilities.getDisplayCurrencyFormat(NetAmount)%></td>
