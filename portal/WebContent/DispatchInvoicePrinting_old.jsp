				...
				<div style="width: 5.5in; border: solid 1px; margin-top: 5px;"
					...
					<table
						...
						<tr style="font-weight: 700; font-size: 12px">
							...
							<td class="formattedRow" nowrap style="text-align: right;">Net
								Amount</td>
						</tr>
						<%
						...
						<tr>
							...
							<td class="formattedRow"
								style="text-align: right; padding-right: 5px;"><%=Utilities.getDisplayCurrencyFormat(RateRawCaseBase)%></td>
							<%-- Rate --%>
							<td class="formattedRow"
								style="text-align: right; padding-right: 5px;"><%=Utilities.getDisplayCurrencyFormat(NetAmountBase)%></td>
							<%-- NetAmount --%>
							<td class="formattedRow"
