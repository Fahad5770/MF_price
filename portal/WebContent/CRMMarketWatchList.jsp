...
<ul data-role="listview" data-inset="true" class="ui-icon-alt" data-theme="d" data-divider-theme="c" data-count-theme="c" style="margin-top: -13px;" id="datathememw">
				...
				ResultSet rs22 = s.executeQuery("SELECT cmw.id,cmw.outlet_id,cmw.outlet_name,cmw.distributor_id,(select name from common_distributors cd where cd.distributor_id=cmw.distributor_id) distributor_name FROM crm_market_watch cmw where created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+WhereDistributors+" order by cmw.distributor_id");
				...
				while(rs22.next()){
					...
					<li style="height: 40px; " >
						...
						<a data-ajax="false" id="mw_outlet_id_<%=rs22.getString("id")%>" href="#"  style=" " onclick="OpenMarketWatchForm('<%=rs22.getString("id")%>');" style="font-size:10px" >
							...
							<%=rs22.getString("outlet_id")%> - <%=rs22.getString("outlet_name")%><br/>
