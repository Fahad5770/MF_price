...
<body style="font-family:Helvetica,Arial,sans-serif">
			  	...
			  	<table border="0" style="width: 100%">
	              	<tr>
	                    ...
	                    <td align="right" style="padding-right: 20px"><b>Complaint List / Sales</b></td>
	                </tr>
	            </table>
				...
				<table style="width: 100%; margin-top: 5px; padding-left: 20px;padding-right: 20px">
			  	...
			  	<hr />
			  	<div align="left" style="padding-left:20px;font-weight: 700; margin-bottom:5px; font-size: 15px"><b></b></div>
			  	...
			  	<table align="center" style="width: 95%; font-size:12px; margin-bottom:10px" border="0" cellspacing="0">
             		...
             		<%
					ResultSet rs = s.executeQuery("SELECT cca.id,cca.outlet_id,cca.outlet_name,cca.outlet_address,cca.outlet_contact_no,cca.type_id,cct.label type_label,cca.description,cca.urdu_description,cca.department_id,cd.label department_label FROM crm_complaints_assigned cca join crm_complaints_types cct on cca.type_id = cct.id join crm_departments cd on cca.department_id = cd.id and cca.department_id=1 join crm_complaints cc on cc.id=cca.id "+WhereDate+" and cc.is_resolved != 1");
					while(rs.next()){
					%>
