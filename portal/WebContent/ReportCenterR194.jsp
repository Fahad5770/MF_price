...
if (DistributorID != 0){
	WhereCustomerID = " and ecer.distributor_id in ("+DistributorID+") ";
					...
					<tbody>
						...
						<tbody>
							...
							while(rs.next()){
								...
								long[] ConvertedCases = Utilities.getRawCasesAndUnits(rs.getLong("total_units"),rs.getInt("unit_per_sku"));
								TotalTotalUnits += rs.getLong("total_units");
