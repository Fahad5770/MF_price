...
if(Utilities.isAuthorized(281, SessionUserID) == false){
...
<head>
        ...
        <script src="js/ProductPerCaseDiscountsRequest.js?13111123=13111123"></script>
...
<div data-role="page" id="BrandExchange" data-url="BrandExchange" data-theme="d">
   ...
   <jsp:include page="Header2.jsp" >
    	<jsp:param value="Product Per Case Discounts Request" name="title"/>
   </jsp:include>
	...
	<table border="0" style="width: 100%;">
		...
		<tr style="font-size: 10pt; font-weight: 400;">
			...
			<td>
				<div id="DiscReqErrorSumamry" style="color:red; margin-left:10px;"></div>
		...
		<table data-role="table" data-mode="reflow" class="ui-body-d table-stripe ui-responsive" style="font-size: 10pt;">
		  <thead>
		    ...
		    <tr class="ui-bar-c">
				...
				<th data-priority="1">Percase Discount</th>
    ...
    <div data-role="popup" id="popupDialogDeactivate" data-overlay-theme="a" data-theme="c" data-dismissible="true" style="min-width:700px; overflow-y: auto; min-height:600px; max-height: 600px" aclass="ui-corner-all">
        ...
        <div data-role="content" data-theme="d" class="ui-corner-bottom ui-content" >
				...
				<table border="0" style="width: 100%; margin-top: 0px; padding: 0px;" class="workflow_form_font">
							...
							<tr>
								<td><b>Valid From:</b> 17/12016</td>
								<td><b>Valid To:</b> 25/10/2016</td>
							</tr>
							<tr>
								...
								<tr style="b1ackground-color:#efedee">								
									<td style=" padding:5px;" valign="top"><label>CSD</label></td>
									<td style=" padding:5px;"><label>Pepsi</label></td>
									<td style=" padding:5px;"><label>100669-Z.D</label></td>
								</tr>
								<tr>	
									<th  style="background-color:#efedee; padding:5px;font-size:12px; ">Quantity</th>
									<th  style="background-color:#efedee; padding:5px;font-size:12px; ">Per Case Discount Rate</th>
							...
							<tr>
								<td>
									<a  data-theme="b" data-role="button" data-inline="true" data-mini="true" id="" href="#"  onClick="">Delete Discount</a>
								</td>
							</tr>
