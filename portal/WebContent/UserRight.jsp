...
<head>
        ...
        <script src="js/UserRight.js"></script>
...
<div data-role="page" id="UserRight" data-url="UserRight" data-theme="d">
    ...
    <jsp:include page="Header2.jsp" >
    	<jsp:param value="User Rights" name="title"/>
    </jsp:include>
	...
	<li>
		...
		<table border="0" style="width: 100%">
			...
			<td style="width: 25%;"><input type="password" name="password" id="password"  placeholder="Password"  title="Password data-mini="true" readonly="readonly"/></td>
			
			<td style="width: 25%;"><input type="text" name="FirstName" id="FirstName" placeholder="First Name" title="First Name" data-mini="true" readonly="readonly"/></td>
			<td style="width: 25%;"><input type="text" name="LastName" id="LastName" placeholder="Last Name"  title="Last Name" data-mini="true" readonly="readonly"/></td>
			</tr>
			<tr>
			<td style="width: 25%;"><input type="text" name="DisplayName" id="DisplayName" placeholder="Display Name" title="Display Name" data-mini="true" readonly="readonly"/></td>			
			<td style="width: 25%;"><input type="text" name="Email" id="Email" placeholder="Email" title="Email" data-mini="true" readonly="readonly"/></td>
			<td style="width: 25%;"><input type="text" name="Disignation" id="Disignation" placeholder="Designation" title="Designation" data-mini="true" readonly="readonly"/></td>			
			<td style="width: 25%;"><input type="text" name="Department" id="Department" placeholder="Department" title="Department" data-mini="true" readonly="readonly"/></td>
   ...
   <% 
            ...
            <div data-role="collapsible" data-collapsed="true" data-theme="c" data-content-theme="d" id="AdditionalRightDiv" data-mini="true">
	    		<h4><%=rs.getString(2) %></h4>
				    ...
				    ResultSet rs2 = s2.executeQuery("SELECT f.feature_id,f.feature_name, f.url, f.ajax_call FROM features f, user_access_admin uaa where f.feature_id=uaa.feature_id and uaa.user_id="+SessionUserID+" and f.group_id="+rs.getString(1)+" and f.active=1 order by f.sort_order");
	            	%>
				   ...
				   <div style="width:80%; float:left;">
    					...
    					<label for="FeatureCheckbox<%=rs2.getString(1) %>" ><%if (rs.getInt(1) != 10){ %>F<%=rs2.getString("feature_id")%> -<%} %> <%=rs2.getString(2)%> </label>
	...
	<div>
		<table style="width: 100%;">
			<tr>
				<td>
					<a data-icon="check" data-theme="a" data-role="button" data-inline="true" id="DeliveryNoteSave" href="#" onClick="UserRightSubmit();" class="ui-disabled" >Save</a>
                    
                    <button data-icon="check" data-theme="b" data-inline="true" id="DeliveryNoteReset" onClick="javascript:window.location='UserRight.jsp'" >Reset</button>
