...
<script>
           ...
           boolean IsEmptyDistributor = true;
            ...
            if(session.getAttribute(UniqueVoID+"_SR1SelectedDistributors") != null){
        	   ...
        	   Query = "SELECT distinct id, label FROM pep.distributor_beat_plan_all_view where distributor_id in ("+DistributorIds+")";
           ...
           //System.out.println(Query);
            ...
            if (session.getAttribute(UniqueVoID+"_SR1SelectedPJP") != null){
            	SelectedPJPArray = (long[])session.getAttribute(UniqueVoID+"_SR1SelectedPJP");           	
            }
            while(rs.next()){
