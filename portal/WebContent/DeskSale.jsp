...
if(Utilities.isAuthorized(52, SessionUserID) == false){
...
long region_id= (rsRegion.first()) ? rsRegion.getLong("region_id") : 0;
%>
<html>
...
<head>
        ...
        <script src="js/DeskSale.js?<%=Math.random()%>=<%=Math.random()%>"></script>
...
<div data-role="page" id="DeskSale" data-url="DeskSale" data-theme="d">
    ...
    <jsp:include page="Header3.jsp" >
    	<jsp:param value="Desk Sales" name="title"/>
	...
	<table border="0" style="width: 100%">
		...
		<tr>
			...
			<td style="width: 20%;">
			<input type="text" placeholder="Shelf Rent" id="ShelfRent" name="ShelfRent" data-mini="true" readonly="readonly" tabindex="-1" >
	...
	<form action="test2.jsp" name="DeskSaleMainForm" id="DeskSaleMainForm">
    			<input type="hidden" id="ShelfRent1" name="ShelfRent1" data-mini="true" readonly="readonly" tabindex="-1" >
		...
		<input type="hidden" name="DeskSaleRegionIDHidden" id="DeskSaleRegionIDHidden" value=<%=region_id %> >
		
		<input type="hidden" name="DeskSaleSalesTaxRateHidden" id="DeskSaleSalesTaxRateHidden" value="0" >
		<input type="hidden" name="DeskSaleWHTaxHidden" id="DeskSaleWHTaxHidden" value="0>" >
        	...
        	<tr>
        		...
        		<td id="DeskSalePackageStatusTable" style="width:30%;" valign="top">
        			...
        			<table>
        				...
        				<tr>
        					<td><lable style="font-size: 10pt; font-weight: 400;">Total Amount without Disc.</lable></td>
			...
			<tr>
				<td>
                   ...
                   <!--   <a data-icon="check" data-theme="b" data-role="button" data-inline="true" id="DeskSalePrint" href="DeskSalePrint.jsp?DeliveryID=<% if( isEditCase ){ out.print(EditID); }else if( isPrintCase ){ out.print(DeskSaleIDPrint); } %>" target="_blank" <% if( isEditCase == false && isPrintCase == false ){ %> class="ui-disabled" <% } %>  >Print</a> -->
                    ...
                    <button data-icon="check" data-theme="b" data-inline="true" id="DeskSaleReset" onClick="javascript:window.location='DeskSale.jsp'" >Reset</button>
                    <% if( isEditCase ) { %>
