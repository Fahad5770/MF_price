			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					<tbody>
					    ...
					    <tr style="font-size:11px;">							
							...
							<th style="text-align:center;  width:5%">Request ID</th>
							<th style="text-align:center;  width:10%">Processed On</th>
							<th data-priority="1"  style="text-align:center;  width:25%">Customer</th>				
							<th data-priority="1"  style="text-align:center;  width:10%">Credit Limit</th>
							<th data-priority="1"  style="text-align:center;  width:10%">Valid From</th>							
							<th data-priority="1"  style="text-align:center;  width:10%">Valid To</th>							
							...
							<th data-priority="1"  style="text-align:center;  width:5%">Branch</th>
							<th data-priority="1"  style="text-align:center;  width:5%">Bank</th>	
						...
						<tr>
							...
							<td><%=CLRequestID %></td>
							<td><%=Utilities.getDisplayDateFormat(rs.getDate("processed_on")) %></td>
							<td>
