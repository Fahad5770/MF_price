...
long ParamDistributorID = Utilities.parseLong(request.getParameter("OrderInvoicingDistributorID"));
...
Distributor UserDistributor[] = UserAccess.getUserFeatureDistributor(SessionUserID, 58);
...
if( UserDistributor != null ){
	...
	else
	{
		...
		if(DistributorID != ParamDistributorID){
			response.sendRedirect("AccessDenied.jsp");
		}
	}
}
...
<head>
        ...
        <script src="js/OrderInvoicingEdit.js"></script>
...
<div data-role="page" id="DeskSale" data-url="DeskSale" data-theme="d">
    ...
    <jsp:include page="Header3.jsp" >
    	<jsp:param value="Edit Order" name="title"/>
	...
	<table border="0" style="width: 100%">
		...
		<tr>
			<td style="width: 15%;" >
				<input type="text" placeholder="Outlet ID" id="DeskSaleOutletID" name="DeskSaleOutletID" data-mini="true" maxlength="10" readonly="readonly">
			</td>
			<td style="width: 20%;">
    ...
    <table>
		<tr>
			...
			<td valign="top" style="width:10%">
				<input type="text" placeholder="Product Code" id="DeskSaleProductCode" name="DeskSaleProductCode" data-mini="true" onBlur="getProductInfoJson(this.value)" >
			</td>
			<td valign="top" style="width:10%">
			...
			<td valign="top" style="width:10%">
				<input  type="text" placeholder="Discount" id="DeskSaleDiscount" name="DeskSaleDiscount" data-mini="true" onchange="DeskSaleCalculate()">
			</td>
			<td valign="top" style="width:10%">
	...
	<form action="test2.jsp" name="DeskSaleMainForm" id="DeskSaleMainForm">
		...
		<input type="hidden" name="DeskSaleDistributorIDHidden" id="DeskSaleDistributorIDHidden" value="" >
		...
		<input type="hidden" name="DeskSaleCreatedByHidden" id="DeskSaleCreatedByHidden" value="" >
	...
	<div>
		<table style="width: 100%;">
			<tr>
				<td>
					<a data-icon="check" data-theme="a" data-role="button" data-inline="true" id="DeskSaleSave" href="#" class="ui-disabled" onClick="OrderInvoicingEditSubmit();">Save</a>
                    ...
                    <button data-icon="check" data-theme="b" data-inline="true" id="DeskSaleReset" onClick="javascript:window.location='OrderInvoicing.jsp'" >Cancel</button>
 ...
 <jsp:include page="LookupOutletSearchPopup.jsp" > 
    	...
    	<jsp:param value="58" name="OutletSearchFeatureID" />
