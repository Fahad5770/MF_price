			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					 ...
					 //	WherePJP=" and isa.outlet_id in (SELECT distinct outlet_id FROM distributor_beat_plan_schedule where id in(974))";
					 	...
					 	<tr style="font-size:11px;">
							...
							<th  data-priority="1"  style="text-align:center; " colspan="1" >500G</th>
							<th   data-priority="1"  style="text-align:center; " colspan="5" >250G</th>
							<th   data-priority="1"  style="text-align:center; ">25G</th>							
							...
							<th  data-priority="1"  style="text-align:center; " colspan="3">Wrapped Gur Jar</th>
							...
							<th  data-priority="1"  style="text-align:center; " colspan="1">510G </th>
					...
					<tbody>
						...
						double TotalArray[]=new double[59];
								...
								double Converted=0;
								 ...
								 TotalUnitPerSKU140G=0;
									...
									if(rs91222.first()){
									 ...
									 ////////////////////////////////////////////////////////////////////////////////
										/////System.out.println("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=1  order by isa.id desc");
										...
										ResultSet rs281=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=17 order by isa.id desc");
										if(rs281.first()){
											Unit_Box450G_Gur = rs281.getDouble(1);
										}
										...
										ResultSet rs334=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=32 order by isa.id desc");
										if(rs334.first()){
										...
										TotalArray[55]+=Unit_500G_ShakkarPack;
										TotalArray[56]+=Sugar_800Gm;
										TotalArray[57]+=Converted;
										TotalArray[58]+=TotalAmount;
									...
									<tr style="font-size:11px;">
										...
										<td style="text-align:left;"><%=Utilities.getDisplayDateFormat (CreatedOn)%></td>
