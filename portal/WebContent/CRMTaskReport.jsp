...
<script type="text/javascript">
	...
	function OpenComplaintForm(ComplaintID, IsAssigned){ 
		...
		var url = 'CRMTaskForm.jsp?ComplaintID='+ComplaintID+'&UniqueSessionID=<%=UniqueSessionID%>';
	...
	function PoplulateTasks(){
		...
		$.get("CRMTaskList.jsp?IsResolved="+isResolved+"&IsSent="+isSent+"&UniqueSessionID=<%=UniqueSessionID%>", function(data) {
			  $.mobile.hidePageLoadingMsg();
			  $("#TasksDIV").html(data); 
	...
	<tr>
		...
		<td style="width: 30%" valign="top">
			...
			<fieldset data-role="controlgroup"  style="margin-top:-13px;">
			     	...
			     	<input type="radio" name="radio-choice" id="radio-choice-1" value="choice-1" checked="checked" data-mini="true" onclick="setResolveStatus(0)"  />
			     	<label for="radio-choice-1">Not Resolved</label>
			
			     	<input type="radio" name="radio-choice" id="radio-choice-2" value="choice-2" data-mini="true" onclick="setResolveStatus(1)"   />
			     	<label for="radio-choice-2">Resolved</label>
			
			</fieldset>
			
			<fieldset data-role="controlgroup"  style="margin-top:0px;">
			
			     	<input type="radio" name="radio-choice2" id="radio-choice-1" value="choice-1" checked="checked" data-mini="true" onclick="setSentStatus(0)"   />
			     	<label for="radio-choice-1">Not Sent</label>
			     	
			     	<input type="radio" name="radio-choice2" id="radio-choice-2" value="choice-2" data-mini="true" onclick="setSentStatus(1)"   />
			     	<label for="radio-choice-2">Sent</label>
