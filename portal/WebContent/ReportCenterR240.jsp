...
function DirectCreditFlow(ReqID,StDate,EnDate,count){
	var IDCounter=count;
	//alert("Proceed button ID is"+IDCounter);
	...
	$.ajax({
    		...
    		success:function(json){
    			...
    			if(json.success == "true"){
    				alert("Successful ");
    				//window.location = 'ReportCenterR240.jsp';
			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					<tbody>
						...
						<tr>
							...
							<td><a  data-role="button" data-inline="true" id="Proceed_<%=Proceedcounter%>" href="#" onClick="DirectCreditFlow('<%=RequestID %>',<%=Utilities.getSQLDate(StartDate) %>,<%=Utilities.getSQLDate(EndDate) %>,<%=Proceedcounter %>)"  aclass="ui-disabled" data-mini="true">Proceed</a></td>
						</tr>
						...
						<%
						Proceedcounter++;
						System.out.println(Proceedcounter);
						}
						%>
						<tr>
