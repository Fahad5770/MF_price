...
<script type="text/javascript">
	...
	function OpenMarketWatchForm(WatchID){ 
		...
		var url = 'CRMMarketWatchForm.jsp?WatchID='+WatchID+'&UniqueSessionID=<%=UniqueSessionID%>';
	...
	function PoplulateTasks(){
		...
		$.get("CRMMarketWatchList.jsp?&UniqueSessionID=<%=UniqueSessionID%>", function(data) {
			  $.mobile.hidePageLoadingMsg();
			  $("#TasksDIV").html(data); 
