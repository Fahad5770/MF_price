...
if(Utilities.isAuthorized(91, SessionUserID) == false){
...
<head>
        ...
        <script src="js/GRNProduction.js"></script>
...
<div data-role="page" id="GRNProduction" data-url="GRN" data-theme="d">
    ...
    <jsp:include page="Header2.jsp" >
    	<jsp:param value="GRN Production" name="title"/>
    </jsp:include>
    ...
    <li data-role="list-divider">GRN Production</li>
    <li>	
