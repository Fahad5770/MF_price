...
function ComplaintResolveSubmit(){
	...
	$.mobile.loading( 'show');
	$.ajax({
	    url: "crm/TaskResolveFormExecute",
	    data: $('#TaskResolveForm').serialize(),
	    ...
	    success: function( json ) {
	    	...
	    	if (json.success == "true"){
	    		$('#value1').val( json.TaskID );
	    		$('#TaskResolveFileUpload').submit();
...
function ShowDetail(){
	...
	$.mobile.loading( 'show');
	$.ajax({
	    url: "CRMTaskResolveSetSession.jsp",
	    data: {
	    ...
	    success: function( response ) {
	    	...
	    	//alert("v = "+response);
	    	window.open("ReportCenter.jsp?ReportID=52&UUID=45039481234");
...
<div data-role="page" id="ComplaintResolve" data-url="ComplaintResolve" data-theme="d">
    ...
    <div data-role="header" data-theme="c" data-position="fixed">
	    <div>
		    ...
		    <div style="float:left; width:90%;b1ackground-color:Red; text-align:center;">
		    	<h1 style="font-size: 14pt;float:left; margin-left:45%; text-align:center;">Resolve Complaint</h1>
			</div>
		</div>
	</div>
	...
	<div data-role="content" data-theme="d">
			...
			<form name="TaskResolveFileUpload" id="TaskResolveFileUpload" action="crm/TaskWebUploadImage" method="post" enctype="multipart/form-data" data-ajax="false"  >
