...
function DirectCreditFlow(ReqID,StDate,EnDate){
	...
	$('.proceed').prop('disabled', true).addClass('ui-disabled');
	...
	$.ajax({
    		...
    		success:function(json){
    			...
    			if(json.success == "true"){
    				alert("Request has been proceeded Successfully ");
			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					<tbody>
						...
						<tr>
							...
							<td><input id="proceed" type="button" value="Proceed" class="proceed " onClick="DirectCreditFlow('<%=RequestID %>',<%=Utilities.getSQLDate(StartDate) %>,<%=Utilities.getSQLDate(EndDate) %>)" data-mini="true"/></td>
