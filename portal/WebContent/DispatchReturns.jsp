...
if(Utilities.isAuthorized(85, SessionUserID) == false){
...
<div data-role="page" id="DispatchReturnsMainInner" data-url="DispatchReturnsMainInner" data-theme="d">
    ...
    <div style="float:left; width:90%;b1ackground-color:Red; text-align:center;"><h1 style="font-size: 14pt;float:left; margin-left:45%; text-align:center;">Dispatch Returns</h1>
    
	    <div data-role="navbar" style="width:20%; float:right; margin-right:3px; margin-top:10px;">
	    	<ul>
	        	<li><a href="javascript:LiquidReturns()" class="ui-btn-active" data-ajax="false">Product Returns</a></li>
	        	<%if (Utilities.isAuthorized(59, SessionUserID)){ %>
	        	 <li><a href="javascript:EmptyReturns()" data-ajax="false">Empty Returns</a></li> 
	        	<%} %>
	    	</ul>
		</div><!-- /navbar -->
	</div>
		...
		<table border="0" style="font-size: 10pt; width:25%">
			<tr>
				...
				<fieldset data-role="controlgroup">				   
				    ...
				    <label for="NoLiquReq">No Product Returned</label>				    
				</fieldset>				
