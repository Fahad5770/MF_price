...
if(Utilities.isAuthorized(28, SessionUserID) == false){
...
<div data-role="page" id="SamplingPrintingMain" data-url="SamplingPrintingMain" data-theme="d">
    ...
    <jsp:include page="Header2.jsp" >
    	<jsp:param value="Slip Printing" name="title"/>
    </jsp:include>
    
    <div data-role="content" data-theme="d">

	<form id="SamplingDashboardGenerrateForm" name="SamplingDashboardGenerrateForm" action="SamplingPrinting.jsp" method="POST" data-ajax="false" target="_blank">
		<ul data-role="listview" data-inset="true">
	        <li data-role="fieldcontain">
	            ...
	            <%
	            ResultSet rs = s.executeQuery("select distinct region from outletmaster where region is not null and region != '' order by region");
	            while(rs.next()){
	            	%>
