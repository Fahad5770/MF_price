	...
	<tr>
		...
		<td style="width: 100%" valign="top">
           ...
           <tr class="ui-bar-d">
             ...
             <th style="width:12.5%">Posting ID</th>
             <th style="width:12.5%">Posted By</th>             
             <th style="width:12.5%">Transaction Type</th>
             <th style="width:12.5%">Remarks</th>
             <th style="width:12.5%">Debit</th>
             <th style="width:12.5%">Credit</th>
             <th style="width:12.5%">Balance</th>
           </tr>
         </thead>
         <tbody>
         <%
        LedgerTransaction ledger[] = bean.getLedger1(OutletIds,StartDate,EndDate);
