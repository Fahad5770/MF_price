		...
		<td style="width: 100%" valign="top">
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					<tbody>
						...
						ResultSet rs1 = s.executeQuery("SELECT id, display_name FROM users where id in (select distinct assigned_to from distributor_beat_plan_view where distributor_id in ("+DistributorIDs+") "+WhereRSM+")"); //distributor query
						while(rs1.next()){
