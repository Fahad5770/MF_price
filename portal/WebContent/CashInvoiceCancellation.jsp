...
<head>
        ...
        <script src="js/CashInvoiceCancellation.js"></script>
...
<div data-role="page" id="CashInvoiceCancellation" data-url="CashInvoiceCancellation" data-theme="d">

    <jsp:include page="Header2.jsp" >
    	<jsp:param value="Invoice Force Posting" name="title"/>
    </jsp:include>
	...
	<div class="ui-grid-a" >
	    <div class="ui-block-a" style="width:75%">
	    	<div class="ui-bar " style="min-height:60px">
	    		<form id="CashInvoiceCancellation" data-ajax="false" action="#CashInvoiceCancellation" onSubmit="return showSearchContent();">	
					<table style="width: 40%; margin-top:7px;">
						<tr>
							<td>
								<input type="text" placeholder="Invoice#" id="InvoiceNo" name="InvoiceNo" data-mini="true">
							</td>
