			...
			<ul data-role="listview" data-inset="true" class="ui-icon-alt" data-theme="d" data-divider-theme="a" data-count-theme="b" style="margin-top:-13px;">
				...
				<table border=0 style="font-size:13px; width:100%"  data-role="table" id="SamplingSummary" data-mode="reflow" class="ui-responsive table-stroke">
					  <thead>
			            ...
			            <tr>
			            <td>
			            	<a href="#" data-role="button" data-mini="true" data-theme="c" id="DeliveryNoteButton" onClick="ReceiptFromProdViewEditFormFromSummary()" target="_blank">View</a>
			            </td>
			            <td>
			            	<a href="#" data-role="button" data-mini="true" data-theme="c" id="DeliveryNoteButton" onClick="ReceiptFromProdViewPrintFormFromSummary()" target="_blank">Print</a>
			            </td>
