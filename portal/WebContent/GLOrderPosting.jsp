...
<head>
		...
		<script src="js/GLOrderPosting.js?9000=9000"></script>
...
<div data-role="page" id="GLOrderPostingPage" data-url="GLOrderPostingPage" data-theme="d">

    <jsp:include page="Header3.jsp" >
    	<jsp:param value="Order Posting" name="title"/>
	...
	<div class="ui-grid-a" >
	    <div class="ui-block-a" style="width:75%">
	    	<div class="ui-bar " style="min-height:60px">
				...
				<form name="OrderPostingExecute" id="OrderPostingExecute" action="#" method="post" >
				...
				<ul data-role="listview" data-inset="false" data-divider-theme="c" style="margin-top:20px; margin-left:2px;">
				    ...
				    <li>
					    ...
					    <table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
							...
							<tr>
								<td style="width: 20%; border: 0px; padding-right: 2px">
									<label for="EntryDate" data-mini="true">Entry Date</label>
									<input type="text" name="EntryDate" id="EntryDate" value="" data-mini="true" data-mini="true" readonly="readonly" >
								</td>
								<td style="width: 20%; border: 0px; padding-right: 2px">
									<label for="InvoiceAmount" data-mini="true">Order Amount</label>
    ...
    <div data-role="footer" data-position="fixed" data-theme="b">
		<div>
			<table style="width: 100%;">
				<tr>
					<td>
						<a data-icon="check" data-theme="a" data-role="button" data-inline="true" id="SubmitButton" href="#" onClick="FormValidation();" aclass="ui-disabled" >Post</a>
						<button data-icon="check" data-theme="b" data-inline="true" onClick="javascript:window.location='GLOrderPosting.jsp'" >Reset</button>
					</td>
