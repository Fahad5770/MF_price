...
function DeskSaleAddProduct(){
	...
	if( $('#DeskSaleDistributorID').val() == '' ){
		alert('Please select distributor before adding products');
		document.getElementById('"DeskSaleDistributorID"').focus();
		return false;
	}else{
	...
	$("#DeskSaleDistributorIDHidden").val($("#DeskSaleDistributorID").val());
...
function DeskSaleSubmit(){
	...
	$('#DeskSaleSave').addClass("ui-disabled");
	$.ajax({
	    url: "primarysales/PrimarySalesExecute",
	    ...
	    success: function( json ) {
	    	if (json.success == "true"){
	    		location = "PrimarySalesOrder.jsp";
	    	}else{
	    		$('#DeskSaleSave').removeClass('ui-disabled');
				alert(json.error);
	    	}
