			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					<tbody>
					    ...
					    if (SelectedAccountTypeArray.length > 0){
					    	if(SelectedAccountTypeArray[0] ==1)
					    	{
					    		AccountTypeIDTitle = "Ledger";
					    	}else if(SelectedAccountTypeArray[0] ==2)
					    	{
					    		AccountTypeIDTitle = "Security";
					    	}else if(SelectedAccountTypeArray[0] ==3)
					    	{
					    		AccountTypeIDTitle = "Credit";
					    	}else if(SelectedAccountTypeArray[0] ==4)
					    	{
					    		AccountTypeIDTitle = "Vehicle";
					    	}else if(SelectedAccountTypeArray[0] ==5)
					    	{
					    		AccountTypeIDTitle = "Empty";
					    	}else if(SelectedAccountTypeArray[0] ==6)
					    	{
					    		AccountTypeIDTitle = "Advance against Orders";
					    	}else if(SelectedAccountTypeArray[0] ==7)
					    	{
					    		AccountTypeIDTitle = "Incentive";
					    	}
					    }
					    
					    %>
					    
							<th colspan=8><%=CustomerID%> - <%=AccountTitle %> Type:<%=AccountTypeIDTitle %></th>
						</tr>
