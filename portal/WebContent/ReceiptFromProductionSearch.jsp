...
<%@page import="java.sql.Statement"%>
            ...
            String SQL = "select *  FROM inventory_production_receipts where created_on between "+Utilities.getSQLDate(FromDate)+" and "+Utilities.getSQLDateNext(ToDate)+" order by created_on desc";
            ...
            %>
            <form method="post" action="ReceiptFromProduction.jsp" id="ReceiptFromProductionSearchForm">
