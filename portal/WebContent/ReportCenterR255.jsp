	...
	<tr>
		...
		<%if(DataFlag==0){ 
			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					 <thead>
					   <tr style="font-size:11px;">
					    ...
					    <tr style="font-size:11px;">
		            		 ...
		            		 <th data-priority="1"  style="text-align:center;" >Lifting Date</th>  
							 <th data-priority="1"  style="text-align:center;" >Freight Amount</th>  
					...
					Date LiftingDate = new Date();
					
		            String Query2="SELECT distinct (distributor_id),(select name from common_distributors cd where cd.distributor_id=idn.distributor_id) name,idn.vehicle_no,sap_order_no,freight_amount,created_on FROM pep.inventory_delivery_note idn  where created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+WhereHauContractorID+" ";
					//System.out.println(Query2);
		            ResultSet rs1 = s3.executeQuery(Query2);
					while(rs1.next()){
						double FreighAmount=0;
						...
						FreighAmount=rs1.getDouble("freight_amount");
						FreightTotal+=FreighAmount;
						LiftingDate = rs1.getDate("created_on");
						int PackageIndex = 0;  
					...
					<tr>
						...
						<td  style="text-align:right"> <%if(FreighAmount!=0){%><%=Utilities.getDisplayCurrencyFormatRounded(FreighAmount) %> <%} %></td> 
		            ...
		            %> 
						...
						%>
							<td style="text-align:right"><%if(qty!=0){%><%=qty %><%} %></td>
							<%
								}	
							}
							%>
		             ...
		             %>	 
						...
						<!--  /////////////////////////////////////////////////////    -->
						 <tr>
								...
								<td style="text-align:right"><%if(FreightTotal!=0){%><%=Utilities.getDisplayCurrencyFormatRounded(FreightTotal) %><%} %></td>
								<%
