...
<head>
		...
		<script src="js/GLUnpostInvoice.js"></script>
...
<div data-role="page" id="GLUnpostInvoicePage" data-url="GLUnpostInvoicePage" data-theme="d">

    <jsp:include page="Header3.jsp" >
    	<jsp:param value="Unpost Invoice" name="title"/>
	...
	<div class="ui-grid-a" >
	    <div class="ui-block-a" style="width:75%">
	    	<div class="ui-bar " style="min-height:60px">
				...
				<form name="UnpostInvoiceExecute" id="UnpostInvoiceExecute" action="#" method="post" >
			...
			<table style="width: 100%;">
				<tr>
					<td>
						...
						<button data-icon="check" data-theme="b" data-inline="true" onClick="javascript:window.location='GLUnpostInvoice.jsp'" >Reset</button>
					</td>
