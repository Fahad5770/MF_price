...
<%@page import="java.sql.Statement"%>
            ...
            String SQL = "SELECT * FROM fda_complaints where created_on between "+Utilities.getSQLFromDateTime(FromDate)+" and "+Utilities.getSQLToDateTime(ToDate)+" order by created_on desc ";
            ...
            while(rs.next()){
            	...
            	%>
            	<li><a data-ajax="false" href="FDAComplaintForm.jsp?EditID=<%=rs.getString("case_no")%>">
					<span style="font-size: 10pt; font-weight: 400;"><%=rs.getString("first_name")%> <%=rs.getString("last_name")%></span>
