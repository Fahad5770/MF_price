...
%>
			...
			<tr>
		    	...
		    	<div id="AddeddWareHouse" style="width:70%">
					...
					ResultSet rs2 = s.executeQuery("select *,(select label from common_warehouses cw where cw.id = uaw.warehouse_id) as warehousename from user_access_admin_warehouses uaw where user_id="+request.getParameter("UserID")+" AND feature_id="+request.getParameter("featureid"));
			...
			<div id="AddeddRegion" style="width:70%">
					<ul data-role="listview" data-inset="true" id="populateRegionDataUl" data-mini="true">					    
					  <%
					   //selecting Region
					ResultSet rs3 = s.executeQuery("select * from user_access_admin_regions uar, common_regions cr  where cr.region_id=uar.region_id and user_id="+request.getParameter("UserID")+" AND feature_id="+request.getParameter("featureid"));
				...
				<div id="AddeddDistributor" style="width:70%">
					<ul data-role="listview" data-inset="true" id="populateDistributorDataUl" data-mini="true">					    
					 ...
					 <%
					 ResultSet rs4 = s.executeQuery("select * from common_distributors cd ,user_access_admin_distributors uad where cd.distributor_id = uad.distributor_id and user_id="+request.getParameter("UserID")+" AND feature_id="+request.getParameter("featureid"));
			...
			<div id="AddeddGroupDistributor" style="width:70%">
					<ul data-role="listview" data-inset="true" id="populateGroupDistributorDataUl" data-mini="true">					    
					  <%
					   //selecting Region
					ResultSet rs6 = s.executeQuery("select * from user_access_admin_distributor_groups uadg, common_distributor_groups cdg  where cdg.id=uadg.group_id and user_id="+request.getParameter("UserID")+" AND feature_id="+request.getParameter("featureid"));
