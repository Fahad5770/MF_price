...
<div style="margin-left: 10%;margin-right: 10%;" data-role="page" id="GLCreditLimitPage" data-url="GLCreditLimitPage" data-theme="d">
    ...
    <jsp:include page="Header2.jsp" >
    	<jsp:param value="Password Configuration" name="title"/>
    </jsp:include>
					    ...
					    <table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
							<tr>
								<td style="width: 20%; border: 0px; padding-right: 2px">
									<label for="CustomerID" data-mini="true">Minimum Password Length</label>
									<input type="text" name="request_id" id="request_id" value="8" data-mini="true"  data-mini="true"   >
								</td>
							...
							<tr>
								...
								<td style="width: 20%; border: 0px; padding-right: 2px">
									<label for="CustomerName" data-mini="true">Password Expiry Days</label>
									<input type="text" name="Deactivation_date" id="Deactivation_date" value="30 " data-mini="true" data-mini="true"  >
								</td>
								
							</tr>
							<tr>
								<td style="width: 20%; border: 0px; padding-right: 2px">
									<label for="ValidFrom" data-mini="true">Account Lockout Threshold for Invalid Logon Attempts</label>
									<input type="text" name="reason" id="reason" value="3" data-mini="true"  placeholder="comments" data-mini="true" >
								</td>
							...
							<tr>		
								<td>
									 <fieldset data-role="controlgroup">
								        ...
								        <label for="checkbox-v-2a"><span style="font-weight: normal">With Special Characters</span></label>
								        <input type="checkbox" name="checkbox-v-2b" id="checkbox-v-2b">
								        <label for="checkbox-v-2b"><span  style="font-weight: normal">With Numeric</span></label>
