...
<head>
        ...
        <script src="js/EmptyCreditReceipt.js?121111=121111"></script>
...
<div data-role="page" id="DispatchReturnsMainInner" data-url="DispatchReturnsMainInner" data-theme="d">
 ...
 <jsp:include page="Header3.jsp" >
    	<jsp:param value="Empty Receipt" name="title"/>
...
%>
    			...
    			<tr>
    				<td style="width:50%;"  valign="top">
    					<ul data-role="listview" data-inset="true"  style="font-size:10pt; margin-top:-10px; margin-left:-8px" data-icon="false">
				    			...
				    			<%
				    			ResultSet rs3 = s.executeQuery("SELECT id as package_id,label as package_label FROM inventory_packages where id in(11,1,12,17,18,25,26,13,20) order by sort_order");
				    			while(rs3.next()){
				    			%>
    ...
    <div class="ui-block-b"  style="width:60%">
    	<div class="ui-ba ui-ba1r-e" style="min-height:60px">
    		...
    		<li data-role='list-divider' data-theme='a'>Empty Receipt</li>
	<li>
	<table border="0" style="width: 100%">
		...
		<tr>
			...
			<td><label for="DispatchReturnsArrivalNumber" style="margin:0px">Arrival#</label></td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="text" placeholder="" id="DispatchReturnsArrivalNumber" name="DispatchReturnsArrivalNumber" data-mini="true" value="" >
			</td>
		</tr>
    ...
    <table style="width:800px;">
		<tr>
			...
			<td valign="top" style="width:200px;">
				<select name="EmptyCreditReceiptType15" id="EmptyCreditReceiptType15" data-mini="true">
					...
					<%
					ResultSet rs6 = s.executeQuery("select * from ec_empty_receipt_types where for_receipt = 1");
					while(rs6.next()){
		...
		<input type="hidden" name="DispatchReturnsArrivalNumberhidden" id="DispatchReturnsArrivalNumberhidden"/>
        ...
        <input type="hidden" name="EmptyCreditReceiptBrandIDTempStorage" id="EmptyCreditReceiptBrandIDTempStorage" value=""/>
    ...
    <form name="EmptyCreditPrintExecute" id="EmptyCreditPrintExecute" action="EmptyCreditReceiptPrint.jsp" method="post" data-ajax="false" target="_blank" >
		<input type="hidden" name="EmptyCreditReceiptID" id="EmptyCreditReceiptID" value="" >
	</form>
			...
			<tr>
				 <td  id="DispatchReturnsSaveTD" style="width:30%">
					...
					<tr>
		                ...
		                <td align="right" style="w1idth:10%;">
		                	<input type="text" name="ReceiptIDForPrint" id="ReceiptIDForPrint"/>
		                </td>
		                <td align="right" style="w1idth:10%;">
		                    
		                    <a href="#" data-rel="popup" data-icon="check" data-theme="b" data-role="button" data-inline="true" data-position-to="window" data-transition="pop" id="ViewAllButton" onClick="javascript:doPrintManual()">Search</a>
						</td>
