...
/*  if(UserAccess.isAuthorized(434, SessionUserID, request) == false){
	response.sendRedirect("AccessDenied.jsp");
}  */

 
 if(Utilities.isAuthorized(434, SessionUserID) == false){
	response.sendRedirect("AccessDenied.jsp");
} 
							...
							<tr>
								<td style="text-align: left">
   									...
   									<div id="aExcelFileReady">
   										<a data-mini="true" href="reports/ReportsR339DownloadExcel?UniqueSessionID=<%=UniqueSessionID%>" target="_blank"  >Export to Excel</a>
   								</div>
