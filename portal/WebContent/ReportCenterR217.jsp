...
SelectedDistributorsArray = new long[1];
...
//System.out.println("brrrr - "+SecondaryDistributor);

SelectedDistributorsArray[0] = SecondaryDistributor;
				...
				StockPosting sp = new StockPosting();	
					...
					while(rs.next()){
						...
						while(rs2.next()){
							...
							//System.out.println("Secondary Report - "+SelectedDistributorsArray[0]);
							...
							<tr>
		    					...
		    					<td style="text-align:right; padding-right:10px; border-left: 1px solid #ececec; border-right: 1px solid #ececec"><%if (ClosingUnits < 0){%>E<%}else{%><%=Utilities.convertToRawCases(ClosingUnits, UnitPerSKU)%><%} %></td>
