...
<%@page import="java.sql.Statement"%>
            ...
            String SQL = "select * from sampling_credit_slip_distributor where created_on between "+Utilities.getSQLFromDateTime(FromDate)+" and "+Utilities.getSQLToDateTime(ToDate)+" and is_received=0 order by created_on desc ";
            ...
            while(rs.next()){
            	...
            	%>
            	<li><a data-ajax="false" href="SamplingCreditSlipDistributor.jsp?EditID=<%=rs.getString("id")%>">
