...
long ReceiptFromProductionMainID = Utilities.parseLong(request.getParameter("ReceiptFromProductionID"));
long GRNProBarCode = Utilities.parseLong(request.getParameter("GRNProBarCode"));
...
<body style="font-family:Helvetica,Arial,sans-serif">
			  ...
			  <div style="width: 8.27in; height: 3.3in; border: solid 1px; margin-top: 5px;">
			   <table border="0" style="width:100%">
              	<tr>
                    ...
                    <td style="text-align: right; font-weight: 700; padding-right:10px">Production Gatepass</td>
                ...
                if(GRNProBarCode>0){//means it has barcode
                	Query = "select * from inventory_production_receipts where uvid="+GRNProBarCode;
                   //System.out.println(Query);
                }else{
                	Query = "select * from inventory_production_receipts where id="+ReceiptFromProductionMainID;
                }
               ...
               if(rs.first()){
            	   CreatedBy = rs.getLong("created_by");
            	    ...
            	    ReceiptFromProductionMainID = rs.getInt("id");
            	    SerialNo = rs.getLong("serial_no");
               }
               
               ResultSet rs2 = s.executeQuery("SELECT DISPLAY_NAME FROM users where id="+CreatedBy);
               if(rs2.first()){
                ...
                <tr>
				  		...
				  		<td align="right" style="font-size: 12px"><b>Gatepass#</b> <%=SerialNo %></td>
			  	</tr>
			  	...
			  	<table style="width: 70%;  padding-left: 10px;padding-right: 10px; font-size: 12px" border="0" cellpadding="0" cellspacing="0">
			  		...
			  		<%
			  		ResultSet rs1 = s.executeQuery("select * from inventory_production_receipts_products iprp,inventory_products_view ipv where iprp.id="+ReceiptFromProductionMainID+" and iprp.product_id=ipv.product_id");
		              while(rs1.next()){
