...
<fieldset data-role="controlgroup" data-corners="true" style="margin-left: 0px; margin-top: -10px; padding-top: 0px;">
           ...
           if (session.getAttribute(UniqueVoID+"_SR1SelectedBrands") != null){
            ...
            ResultSet rs = s.executeQuery("SELECT distinct brand_id as id ,(select label from inventory_brands ib where ib.id=brand_id) label FROM inventory_products where category_id in(2,3)");
