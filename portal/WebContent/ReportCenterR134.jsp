...
<li data-role="list-divider" data-theme="a">Summary<span style="float:right; "><a href="ReportCenterR134ComplaintListPrint.jsp" style="text-decoration:none; color:white;" target="_blank">Print</a></span></li>
<li>
<%
	...
	<tr>
		...
		<td style="width: 100%" valign="top">
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					...
					ResultSet rs1 = null;
					ResultSet rs = s.executeQuery("SELECT cca.id,cca.outlet_id,cca.outlet_name,cca.outlet_address,cca.outlet_contact_no,cca.type_id,cct.label type_label,cca.description,cca.urdu_description,cca.department_id,cd.label department_label FROM crm_complaints_assigned cca join crm_complaints_types cct on cca.type_id = cct.id join crm_departments cd on cca.department_id = cd.id and cca.department_id=1 join crm_complaints cc on cc.id=cca.id "+WhereDate+" "+ComplaintTypeIDWhere+WhereDistributors+WhereRSM+WhereHOD+WhereSM+WhereTDM+WhereASM+WhereAssigned+WhereResolved+WhereVerified);
					...
					%>
						...
						<tr>
							...
							<!--  <td style="text-align:left"><a href="#popupDialog" data-rel="popup"  data-position-to="window" data-transition="pop" id="ResolveComplain" onClick="SetComplaintID(<%=rs.getLong("id") %>)">Resolve</a></td>-->
						</tr>
					<%
					}
					%>
	...
	<div data-role="popup" id="popupDialog1_<%=rs.getLong("id")%>" data-overlay-theme="a" data-theme="c" data-dismissible="true" style="width:450px; overflow-y: auto; height: 650px" aclass="ui-corner-all">
        ...
        <div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
			<div id="slider_<%=rs.getLong("id")%>">
			    ...
			    while(rs2.next()){			    
			    %>
			    <img src="/WorkflowAttachments/<%=rs2.getString("filename")%>" align="middle">
			    <%
			    }
			    %>
