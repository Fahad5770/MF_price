...
<head>
		...
		<script src="js/GLInvoicePosting.js?199999=199999"></script>
...
<div data-role="page" id="GLInvoicePostingPage" data-url="GLInvoicePostingPage" data-theme="d">
    ...
    <jsp:include page="Header3.jsp" >
    	<jsp:param value="Invoice Posting" name="title"/>
				...
				<ul data-role="listview" data-inset="false" data-divider-theme="c" style="margin-top:20px; margin-left:2px;">
				    ...
				    <li>
				    	<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
							...
							<tr>
								<td style="width: 20%; border: 0px; padding-right: 2px">
									<label for="AdvanceAgainstOrder" data-mini="true">Advance against Order</label>
									<input type="text" name="AdvanceAgainstOrder" id="AdvanceAgainstOrder" value="" data-mini="true" readonly="readonly" data-mini="true" >
								</td>
