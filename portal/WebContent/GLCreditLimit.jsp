...
<div data-role="page" id="GLCreditLimitPage" data-url="GLCreditLimitPage" data-theme="d">
    ...
    <jsp:include page="Header2.jsp" >
    	<jsp:param value="Credit Limit" name="title"/>
    </jsp:include>
			...
			<table style="width: 100%;">
				<tr>
					<td>
						...
						<button data-icon="check" data-theme="b" data-inline="true" onClick="javascript:window.location='GLCreditLimit.jsp'" >Reset</button>
						<% if( isEditCase ){ %>
						<button data-icon="check" data-theme="b" data-inline="true" onClick="javascript:window.location='GLCreditLimit.jsp?DeActivate=<%=EditID%>'" >De-Activate</button>
						<% } %>
					</td>
	                <td align="right">
