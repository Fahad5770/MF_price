...
<div data-role="page" id="LiftingReportMain" data-url="LiftingReportMain" data-theme="d">
    ...
    <div style="float:left; width:90%;b1ackground-color:Red; text-align:center;"><h1 style="font-size: 14pt;float:left; margin-left:45%; text-align:center;">Lifting Report</h1>
	    ...
	    <div data-role="navbar" style="width:20%; float:right; margin-right:3px; margin-top:10px;">
	    	<ul>
	        	<li><a href="LiftingReportMain.jsp" class="ui-btn-active" data-ajax="false">Raw Case</a></li>
	        	<%if (Utilities.isAuthorized(49, SessionUserID)){ %>
	        	<li><a href="LiftingReportMainAmount.jsp" data-ajax="false">Invoice Value</a></li>
	        	<%} %>
	    	</ul>
		</div><!-- /navbar -->
	</div>
	...
	<form id="LiftingReportGenerrateForm" name="LiftingReportGenerrateForm" action="LiftingReport3C.jsp" method="POST" data-ajax="false">
		
		<ul data-role="listview" data-inset="true">
	        
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainWarehouseID">Warehouse:</label>
	            <select name="LiftingReportMainWarehouseID" id="LiftingReportMainWarehouseID" data-mini="true">
	            	<%=WarehouseOptions%>
	            </select>
	        </li>
	        ...
	        <li data-role="fieldcontain">
	            ...
	            <select name="LiftingReportMainRegion" id="LiftingReportMainRegion" data-mini="true">
	            	<%=RegionOptions%>
	            </select>
	        </li>
	         
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainDistributorGroup">Distributor Group:</label>
	            <select name="LiftingReportMainDistributorGroup" id="LiftingReportMainDistributorGroup" data-mini="true">
	            <option value="0">All</option>
	            <%
	            ResultSet rs16 = s.executeQuery("SELECT id, label from common_distributor_groups order by created_on desc");
	            while(rs16.next()){
	            %>
	            	<option value="<%=rs16.getString(1)%>"><%=rs16.getString(2)%></option>
	            <%
	            }
	            %>
	            </select>
	        ...
	        <li data-role="fieldcontain">
	            <table style="width:100%; border-collapse:collapse;" border="0" >
            		<tr>
            			...
            			<td style="width:10%">
            				<input type="text" name="LiftingReportMainDistributor" data-mini="true" id="LiftingReportMainDistributor" style="width: 100%" onChange="getDistributorName()">
            			</td>
            			<td style="width:68%">
            				<input type="text" name="LiftingReportMainDistributorName" data-mini="true" id="LiftingReportMainDistributorName" readonly="readonly">
            			</td>
            		</tr>
            	</table>
	        </li>
	        ...
	        <li data-role="fieldcontain">
	            ...
	            <input type="text" name="LiftingReportMainInvoiceNumber" data-mini="true" id="LiftingReportMainInvoiceNumber">
	        </li>
	        
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainPaymentMethod">Payment Method:</label>
	            <select name="LiftingReportMainPaymentMethod" data-mini="true" id="LiftingReportMainPaymentMethod">
	            	<%=Options%>
	            </select>
	        </li>
	        
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainSaleOrderNumber">Sales Order#:</label>
	            <input type="text" name="LiftingReportMainSaleOrderNumber" data-mini="true" id="LiftingReportMainSaleOrderNumber">
	        </li>
	        
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainVehicleNumber">Vehicle 	#:</label>
	            <input type="text" name="LiftingReportMainVehicleNumber" data-mini="true" id="LiftingReportMainVehicleNumber">
	        </li>
	        
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainVehicleType">Vehicle Type:</label>
	            <select name="LiftingReportMainVehicleType" id="LiftingReportMainVehicleType" data-mini="true">
	            	<%=VehicleTypeOptions%>
	            </select>
	        </li>
	        ...
	        <li data-role="fieldcontain">
	            ...
	            <input type="text" name="LiftingReportMainRemakrs" data-mini="true" id="LiftingReportMainRemakrs">
	        </li>
	        
	        <li data-role="fieldcontain">
	            <label for="LiftingReportBatchCode">Batch Code:</label>
	            <input type="text" name="LiftingReportBatchCode" data-mini="true" id="LiftingReportBatchCode">
	        </li>
	        ...
	        <li data-role="fieldcontain">
	             <table style="width:100%; border-collapse:collapse;" border="0" >
            		<tr>
            			...
            			<td style="width:10%">
            				<input type="text" data-mini="true"name="LiftingReportUser" id="LiftingReportUser" onChange="getUserName()">
            			</td>
            			<td style="width:68%">
            				<input type="text"data-mini="true" name="LiftingReportUserName" id="LiftingReportUserName" readonly>
            			</td>
            		</tr>
            	</table>
	         ...
	         <li data-role="fieldcontain">
	             <table style="width:100%; border-collapse:collapse; display:block" border="0" >
            		<tr>
            			<td style="width:22%">
            				<label for="LiftingReportUser">Product:</label>
            			</td>
            			<td style="width:38%" id="PackageSearchTD">
            			
            				<select name="LiftingReportPackage" id="LiftingReportPackage" style="width:100%" data-mini="true">
								<%=bean.getPackageOptions()%>
							</select>
            			</td>
            			<td style="width:40%" id="BrandSearchTD">
            				<select name="LiftingReportBrand" id="LiftingReportBrand" data-mini="true">
								<%=bean.getBrandOptions()%>
							</select>
            			</td>
            		</tr>
            	</table>
	        ...
	        <li data-role="fieldcontain">
	            <label for="LiftingReportMainVehicleType">Delivery Status:</label>
	            
	            <select name="LiftingReportMainDeliveryStatus" id="LiftingReportMainDeliveryStatus" data-mini="true">
	        ...
	        <li>
				...
				<div class="ui-grid-d" style="padding: .7em 15px;">
					...
					<div class="ui-block-b" style="width:20%;"><input id="LiftingReportMainToDate" name="LiftingReportMainToDate" type="text" data-mini="true" placeholder="DD/MM/YYYY" value="<%=Utilities.getDisplayDateFormat(new java.util.Date())%>"></div>
	...
	<jsp:include page="LookupDistributorSearchPopup.jsp" > 
    	...
    	<jsp:param value="37" name="DistributorSearchFeatureID" />
...
$('#LiftingReportMainFromDateHour').val('0').change();
$('#LiftingReportMainFromDateMinutes').val('0').change();

$('#LiftingReportMainToDateHour').val('23').change();
$('#LiftingReportMainToDateMinutes').val('59').change();
