...
function ReportCenterR178LoadBrandsList(ParamDocumentID, ParamPackageID, ParamTypeID){
	
	$('#ReportCenterR178BrandsList').html( "<img src='images/snake-loader.gif' >" );
	
	$.ajax({
	    url: "ReportCenterR178LoadBrandsList.jsp",
	    data: {
...
function ReportCenterR178LoadScopeList(ParamDocumentID){
	
	$('#ReportCenterR167ScopeList').html( "<img src='images/snake-loader.gif' >" );
	
	$.ajax({
	    url: "ReportCenterR178LoadScopeList.jsp",
	    data: {
	    	DocumentID: ParamDocumentID
	    },
	    type: "POST",
					...
					%>
					   ...
					   <!-- <td style="text-align: right;"><%//=Utilities.getDisplayCurrencyFormat(Consumed) %></td>
							...
							if(rs2.first()){
								...
								<td><a href="#popupDialogReportCenterR167BrandsList" data-rel="popup" data-position-to="window" data-transition="pop" onclick="ReportCenterR178LoadBrandsList(<%=rs.getString("id")%>, <%=rs2.getString("package_id")%>, 1)" >View</a></td>
							...
							if(rs3.first()){
								...
								<td><a href="#popupDialogReportCenterR167BrandsList" data-rel="popup" data-position-to="window" data-transition="pop" onclick="ReportCenterR178LoadBrandsList(<%=rs.getString("id")%>, <%=rs3.getString("package_id")%>, 2)" >View</a></td>
							...
							<td><a href="#popupDialogReportCenterR167ScopeList" data-rel="popup" data-position-to="window" data-transition="pop" onclick="ReportCenterR178LoadScopeList(<%=rs.getString("id")%>)" >View</a></td>
