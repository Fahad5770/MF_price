...
function DispatchPrintingGetInvoices(DispatchID){
	...
	$.get('DispatchAdjustedPrintingGetInvoices.jsp?DispatchID='+DispatchID, function(data) {
...
function DispatchPrintingFilterDrivers(){
	...
	$.get('DispatchAdjustedPrintingFilterDrivers.jsp?DispatchAdjustedPrintingAdjustedDate='+$('#DispatchAdjustedPrintingAdjustedDate').val()+'&DistributorID=<%=DistributorID%>', function(data) {
		
		  $("#DispatchAdjustedPrintingDriverDIV").html(data);
		  $("#DispatchAdjustedPrintingDriverDIV").trigger('create');
    ...
    <div>
	    ...
	    <div style="float:left; width:90%;b1ackground-color:Red; text-align:center;"><h1 style="font-size: 14pt;float:left; margin-left:45%; text-align:center;">Dispatch Printing</h1>
		    ...
		    <div data-role="navbar" style="width:20%; float:right; margin-right:3px; margin-top:10px;">
		    	<ul>
		        	<li><a href="DispatchPrinting.jsp" data-ajax="false">Dispatched</a></li>
		        	<li><a href="DispatchAdjustedPrinting.jsp" class="ui-btn-active" data-ajax="false">Adjusted</a></li>
		    	</ul>
			</div><!-- /navbar -->
		</div>
	</div>
...
<table border=0 style="width:100%">
	<tr>
		<td style="width:30%" valign="top">
			<div id="DispatchAdjustedPrintingDriverDIV">
				
			</div>	
			<ul data-role="listview" data-inset="true" class="ui-icon-alt" data-theme="d" data-divider-theme="a" data-count-theme="c">
				
				<li data-role="list-divider" data-theme="a">Adjusted On</li>
				<li>
				
					<table style="width: 100%">
						<tr>
							<td><label for="DispatchAdjustedPrintingDriverDateFilter" style="margin:0px">Date</label></td>
						</tr>
						<tr>
							<td><input id="DispatchAdjustedPrintingAdjustedDate" name="DispatchAdjustedPrintingAdjustedDate" type="text" placeholder="DD/MM/YYYY" data-mini="true" value="<%=Utilities.getDisplayDateFormat(new java.util.Date())%>"  ></td>
						</tr>
					</table>
