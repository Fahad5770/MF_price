...
<div data-role="header" data-id="BeatPlanHeader" data-theme="d">
    ...
    <div data-role="navbar" >
        <ul>
            ...
            <li><a href="EmployeeDashboard.jsp?EmployeeCode=<%=EmployeeCode%>" data-ajax="false" data-transition="none" <%if (tab == 1){%>class="ui-btn-active ui-state-persist"<%} %> >Beat Plan</a></li>
