...
if(Utilities.isAuthorized(423, SessionUserID) == false){
...
<head>
        ...
        <script src="js/DispatchBalanceCashReceipts.js?1234=12345"></script>
...
<div data-role="page" id="DispatchBalanceCashReceiptsMainInner" data-url="DispatchBalanceCashReceiptsMainInner" data-theme="d">
    ...
    <div style="float:left; width:10%">
    	<a href="DispatchBalanceCashReceiptsMain.jsp" data-role="button" data-theme="d" data-inline="true" data-ajax="false" data-icon="back">Back</a>
    </div>
    <div style="float:left; width:90%;b1ackground-color:Red; text-align:center;"><h1 style="font-size: 14pt;float:left; margin-left:45%; text-align:center;">Balance Cash Receipts</h1>
...
int totalSales=0;
 ...
 ResultSet rs11 = s3.executeQuery("SELECT outlet_id FROM pep.inventory_sales_dispatch_cash_receipts where dispatch_id="+DispatchID);
	
	while(rs11.next())
	{
		long OutletID = rs11.getLong("outlet_id");
		ResultSet rs12 = s4.executeQuery("SELECT net_amount FROM pep.inventory_sales_adjusted where id="+OutletID);
...
%>
	<%-- <form id="ReturnsGenerrateForm" name="ReturnsGenerrateForm" action="DispatchBalanceCashReceipts.jsp" method="POST" data-ajax="false">
...
<%-- 	<li>
	<table border="0" style="width: 100%">
		...
		<tr >
			<td style="width: 15%;" >
				<input type="text" placeholder="Vehicle#" id="DispatchBalanceCashReceiptsVehicleNumber" name="DispatchBalanceCashReceiptsVehicleNumber" data-mini="true" maxlength="10" value="<%=VehicleName%>" readonly>
			</td>
			<td style="width: 20%;">
				<input type="text" placeholder="Driver Name" id="DispatchBalanceCashReceiptsDriverName" name="DispatchBalanceCashReceiptsDriverName" data-mini="true" readonly="readonly" tabindex="-1" value="<%=DriverName%>" readonly>
			</td>
			<td style="width: 45%;">
			<input type="text" placeholder="Vehicle type" id="DispatchBalanceCashReceiptsVehicleType" name="DispatchBalanceCashReceiptsVehicleType" data-mini="true" readonly="readonly" tabindex="-1" value="<%=VehicleType%>" readonly>
			</td>
    ...
    <li>	
	<form id="DispatchBalanceCashReceiptsForm" data-ajax="false" action="" onSubmit="return DispatchBalanceCashReceiptsAddProduct();">		
    ...
    <table>
		<tr style="display:none">
			...
			<td valign="top" style="width:10%">
				<input type="text" placeholder="Product Code" id="DispatchBalanceCashReceiptsProductCode" name="DispatchBalanceCashReceiptsProductCode" data-mini="true" >
			</td>
			<td valign="top" style="width:10%">
				<input  type="text" placeholder="Raw Cases" id="DispatchBalanceCashReceiptsRawCases" name="DispatchBalanceCashReceiptsRawCases" data-mini="true">
			</td>
			<td valign="top" style="width:10%">
				<input  type="text" placeholder="Bottles" id="DispatchBalanceCashReceiptsUnits" name="DispatchBalanceCashReceiptsUnits" data-mini="true" >
			</td>
			<%
			...
			<%-- <td valign="top" id="AddDispatchBalanceCashReceiptsBtnTD" <%if(!EmptyResultSet1){ %>class="ui-dis2abled"  <%} %> > --%>
			
		 <td valign="top" id="AddDispatchBalanceCashReceiptsBtnTD" > 
        ...
        <table style="width:100%" border="0">
        	<tr>
        		<td style="width:70%" valign="top" rowspan="2">
	        		<table data-role="table" data-mode="reflow" class="ui-body-d table-stripe ui-responsive" style="font-size: 10pt; width:100%">
					  <thead>
						...
						<tbody id="DispatchBalanceCashReceiptsTableBody">
						...
						<%
									...
									while(rs2.next())
									{
										...
										rowcount++;
										String qry2="SELECT order_id,outlet_id,net_amount FROM pep.inventory_sales_adjusted where id="+SalesID;
										...
										Balance = NetAmount - OrderCashReceipts;
								%>
										 
									
									<tr id='DeskSale<%=rowcount%>'>
										<td><%=SalesID %><input type='hidden' name='DispatchBalanceCashReceiptsOrderID' value='<%=SalesID%>'></td>
										<td><%=OutletID %> - <%=OutletName %><input type='hidden' name='DispatchBalanceCashReceiptsOutletID' value='<%=OutletID %>' ></td>						
										<td><%=NetAmount%></td>
										<td><%=Balance%></td>
										<td><input type='text' data-mini=true name='DispatchBalanceCashReceiptsOrderCashReceipts' onchange="DispatchBalanceCashReceiptsCalculate(<%=totalSales %>)"  id='OrderCashReceipts_<%=rowcount %>' value='<%=Balance %>'></td>
									</tr>
        		...
        		<td id="DeskSalePackageStatusTable" style="width:30%;" valign="top">
        			<div id="DispatchBalanceCashReceiptsSummary"></div>
...
<%-- 		<table border="0" style="width: 30%">
		<tr >
			...
			<td style="width: 25%;">
				<input type="text" placeholder="Cash Received" id="DispatchBalanceCashReceiptsCashReceived" name="DispatchBalanceCashReceiptsCashReceived" data-mini="true" readonly="readonly" tabindex="-1" value="<%=CashReceived%>" readonly>
			</td>
			</tr>
			<tr>
			<td style="width: 25%;">
			...
			<td style="width: 25%;">
			<input type="text" placeholder="Remaining Amount" id="DispatchBalanceCashReceiptsRemainingAmount" name="DispatchBalanceCashReceiptsRemainingAmount" data-mini="true"   value="<%=RemainingBalance%>" >
			</td>
	...
	<div>
		<table style="width: 100%;">
			<tr>
				 <td  id="DispatchBalanceCashReceiptsSaveTD">
				
					
					<a data-icon="check" data-theme="a" data-role="button" data-inline="true" id="DispatchBalanceCashReceiptsSave" href="#" class="ui-di2sabled" onClick="DispatchBalanceCashReceiptsSubmit();">Save</a>
