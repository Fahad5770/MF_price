	...
	<tr>
		<td style="width:30%" valign="top">
            ...
            %>
				...
				%>
				<li>
					<a data-ajax="false" href="<%=rs2.getString("url") %>" style="font-size:13px">
						<%=rs2.getString("feature_name") %>
						<br/><span style="padding-top:10px; font-weight:normal; "><div style="white-space: normal;"><%=rs2.getString("description") %></div></span>
						<!-- <br/><span class="temp" style="padding-top:10px; font-weight:normal;"><%//=rs2.getString("description") %></span> -->
					</a>
				</li>
