...
function SaveProductTaxList() {
    ...
    $.ajax({
        ...
        success: function(response) {
         ...
         //   console.log('Success:', response);
            ...
            window.location='ProductsIncomeTax.jsp';
    ...
    <div data-role="page" id="PriceList" data-url="PriceList" data-theme="d">
        <jsp:include page="Header2.jsp">
            <jsp:param value="Product WithHolding Tax" name="title"/>
        </jsp:include>
        ...
        <div data-role="content" data-theme="d">
            <form id="PriceTaxList">    
                <ul data-role="listview" data-inset="false" data-divider-theme="c">
                    ...
                    <div></div>
                    <li data-role="list-divider">Product WithHolding Tax</li>
                    <li>   
                        <table border="0" width="100%">
                            ...
                            <%
                                ...
                                while(rs.next()) {
                                    ...
                                    ResultSet rsDetails = s1.executeQuery("select * from inventory_product_income_tax where product_id = "+productId+" ");
