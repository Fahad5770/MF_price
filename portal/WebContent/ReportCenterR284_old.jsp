...
Statement s6 = c.createStatement(java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY);

Statement s7 = c.createStatement(java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY);
Statement s8 = c.createStatement(java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY);
			...
			<table border=0 style="font-size:13px; font-weight: 400; width:100%" cellpadding="0" cellspacing="0"  adata-role="table" class="GridWithBorder">
					 ...
					 //	WherePJP=" and isa.outlet_id in (SELECT distinct outlet_id FROM distributor_beat_plan_schedule where id in(974))";
					 	...
					 	<tr style="font-size:11px;">
							...
							<th  data-priority="1"  style="text-align:center; " colspan="1">Premium Packed Sugar 800 Gm</th>
							...
							<th  data-priority="1"  style="text-align:center; " colspan="1">510 G </th>
							<th  data-priority="1"  style="text-align:center; " colspan="1">100 G </th>
							<th  data-priority="1"  style="text-align:center; " colspan="1">200 G </th>

							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							...
							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Jar 240 G</th>
							<th   data-priority="1"  style="text-align:center; " >Sugar SMP</th>
							<th   data-priority="1"  style="text-align:center; " >Sugar SMP</th>
							<th   data-priority="1"  style="text-align:center; ">Gurr Box 360 Gm</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Box 360 Gm</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Box 360 Gm</th>
							<th   data-priority="1"  style="text-align:center; ">Gurr Box 360 Gm</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Box 360 Gm</th>
							...
							<th   data-priority="1"  style="text-align:center; " >Gurr Box 360 Gm</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Box 360 Gm</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Box 408 Gm</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Chana</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Chana</th>
							<th   data-priority="1"  style="text-align:center; " >Gurr Chana </th>
							<th   data-priority="1"  style="text-align:center; " >Sugar SMP</th>
					...
					<tbody>
						<tr style="font-size:11px;">
							...
							<th   data-priority="1"  style="text-align:center; " >Original</th>
							<th   data-priority="1"  style="text-align:center; " >Fennel (Saunf)</th>
							<th   data-priority="1"  style="text-align:center; " >Coconut</th>
							<th   data-priority="1"  style="text-align:center; " >Ginger</th>
							<th   data-priority="1"  style="text-align:center; " >Orange peal</th>
							<th   data-priority="1"  style="text-align:center; " >Pan Masala</th>
							<th   data-priority="1"  style="text-align:center; ">Strawberry</th>
							<th   data-priority="1"  style="text-align:center; " >Ajwain</th>
							<th   data-priority="1"  style="text-align:center; " >60 G</th>
							<th   data-priority="1"  style="text-align:center; ">120 G</th>
							<th   data-priority="1"  style="text-align:center; " >Original</th>
							<th   data-priority="1"  style="text-align:center; " >Fennel (Saunf)</th>
							<th   data-priority="1"  style="text-align:center; ">Orange peal</th>
							<th   data-priority="1"  style="text-align:center; " >Ginger</th>
							...
							<th   data-priority="1"  style="text-align:center; " >Strawberry</th>
							<th   data-priority="1"  style="text-align:center; " >Ajwain</th>
							<th   data-priority="1"  style="text-align:center; " >408 GM</th>
							<th   data-priority="1"  style="text-align:center; " >30 GM</th>
							<th   data-priority="1"  style="text-align:center; " >62 GM</th>
							<th   data-priority="1"  style="text-align:center; " >Jar </th>
							<th   data-priority="1"  style="text-align:center; " >400 GM</th>
							<th   data-priority="1"  style="text-align:center; " >Shakkar Pack 500 gm</th>
							...
							Channel=rs.getString("channel");
						       ...
						       if(Channel==null){
								...
								// System.out.println("SELECT distinct created_on FROM pep.inventory_sales_adjusted where created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+" and outlet_id="+OutletID);
									ResultSet rs34 = s3.executeQuery("SELECT distinct date(created_on) created_on FROM pep.inventory_sales_adjusted where created_on between "+Utilities.getSQLDate(StartDate)+" and "+Utilities.getSQLDateNext(EndDate)+" and outlet_id="+OutletID+"");
									while(rs34.next()){
										...
										long GurBox425G=0;
										double Unit_510G_Gur=0;
										long Unit_100G_Shakkar=0;
										long Unit_200G_Shakkar=0;
										
										//NEw SKU added on 22-12-22
										double Unit_240G_Original=0;
										double Unit_240G_Fennel=0;
										double Unit_240G_Coconut=0;
										double Unit_240G_Ginger=0;
										double Unit_240G_Orange=0;
										double Unit_240G_Pan=0;
										double Unit_240G_Strawberry=0;
										double Unit_240G_Ajwain=0;
										
										double Unit_60G_SugarSMP=0;
										double Unit_120G_SugarSMP=0;
										
										double Unit_360G_Original=0;
										double Unit_360G_Fennel=0;
										double Unit_360G_Orange=0;
										double Unit_360G_Ginger=0;
										double Unit_360G_Coconut=0;
										double Unit_360G_Pan=0;
										double Unit_360G_Strawberry=0;
										double Unit_360G_Ajwain=0;
										
										double Unit_408GM_GurrBox=0;
										
										double Unit_30GM_GurrChana=0;
										double Unit_62GM_GurrChana=0;
										double Unit_Jar_GurrChana=0;
										
										double Unit_400G_SugarSMP=0;
										
										double Unit_500G_ShakkarPack=0;
										...
										double ConvertedUnit_Unit_500G_ShakkarPack=0;
										...
										double ConvertedUnit510GGur=0;
										double ConvertedUnit_Unit_100G_Shakkar=0;
										double ConvertedUnit_Unit_200G_Shakkar=0;
										
										//NEw SKU added on 22-12-22
										double Converted_240G_Original=0;
										double Converted_240G_Fennel=0;
										double Converted_240G_Coconut=0;
										double Converted_240G_Ginger=0;
										double Converted_240G_Orange=0;
										double Converted_240G_Pan=0;
										double Converted_240G_Strawberry=0;
										double Converted_240G_Ajwain=0;
										
										double Converted_60G_SugarSMP=0;
										double Converted_120G_SugarSMP=0;
										
										double Converted_360G_Original=0;
										double Converted_360G_Fennel=0;
										double Converted_360G_Orange=0;
										double Converted_360G_Ginger=0;
										double Converted_360G_Coconut=0;
										double Converted_360G_Pan=0;
										double Converted_360G_Strawberry=0;
										double Converted_360G_Ajwain=0;
										
										double Converted_408GM_GurrBox=0;
										
										double Converted_30GM_GurrChana=0;
										double Converted_62GM_GurrChana=0;
										double Converted_Jar_GurrChana=0;
										
										double Converted_400G_SugarSMP=0;
										...
										ResultSet rs91=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (35)  order by isa.id desc");
										if(rs91.first()){
											Unit_240G_Original = rs91.getDouble(1);
										}
										
										ResultSet rs92=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (36)  order by isa.id desc");
										if(rs92.first()){
											Unit_240G_Fennel = rs92.getDouble(1);
										}
										
										ResultSet rs93=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (37)  order by isa.id desc");
										if(rs93.first()){
											Unit_240G_Coconut = rs93.getDouble(1);
										}
										
										ResultSet rs94=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (38)  order by isa.id desc");
										if(rs94.first()){
											Unit_240G_Ginger = rs94.getDouble(1);
										}
										
										ResultSet rs95=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (39)  order by isa.id desc");
										if(rs95.first()){
											Unit_240G_Orange = rs95.getDouble(1);
										}
										
										ResultSet rs96=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (40)  order by isa.id desc");
										if(rs96.first()){
											Unit_240G_Pan = rs96.getDouble(1);
										}
										
										ResultSet rs97=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (41)  order by isa.id desc");
										if(rs97.first()){
											Unit_240G_Strawberry = rs97.getDouble(1);
										}
										
										ResultSet rs98=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (42)  order by isa.id desc");
										if(rs98.first()){
											Unit_240G_Ajwain = rs98.getDouble(1);
										}
										
										ResultSet rs99=s2.executeQuery("SELECT sum(total_units/12) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (43)  order by isa.id desc");
										if(rs99.first()){
											Unit_60G_SugarSMP = rs99.getDouble(1);
										}
										
										ResultSet rs911=s2.executeQuery("SELECT sum(total_units/10) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (44)  order by isa.id desc");
										if(rs911.first()){
											Unit_120G_SugarSMP = rs911.getDouble(1);
										}
										
										
										ResultSet rs912=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (45)  order by isa.id desc");
										if(rs912.first()){
											Unit_360G_Original = rs912.getDouble(1);
										}
										
										ResultSet rs913=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (46)  order by isa.id desc");
										if(rs913.first()){
											Unit_360G_Fennel = rs913.getDouble(1);
										}
										/////////////////////////
										
										ResultSet rs916=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (47)  order by isa.id desc");
										if(rs916.first()){
											Unit_360G_Orange = rs916.getDouble(1);
										}
										
										ResultSet rs915=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (48)  order by isa.id desc");
										if(rs915.first()){
											Unit_360G_Ginger = rs915.getDouble(1);
										}
										
										ResultSet rs914=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (49)  order by isa.id desc");
										if(rs914.first()){
											Unit_360G_Coconut = rs914.getDouble(1);
										}
										
										ResultSet rs917=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (50)  order by isa.id desc");
										if(rs917.first()){
											Unit_360G_Pan = rs917.getDouble(1);
										}
										
										ResultSet rs918=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (51)  order by isa.id desc");
										if(rs918.first()){
											Unit_360G_Strawberry = rs918.getDouble(1);
										}
										
										ResultSet rs919=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (52)  order by isa.id desc");
										if(rs919.first()){
											Unit_360G_Ajwain = rs919.getDouble(1);
										}
										
										ResultSet rs9191=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (53)  order by isa.id desc");
										if(rs9191.first()){
											Unit_408GM_GurrBox = rs9191.getDouble(1);
										}
										
										ResultSet rs9111=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (54)  order by isa.id desc");
										if(rs9111.first()){
											Unit_30GM_GurrChana = rs9111.getDouble(1);
										}
										
										ResultSet rs9122=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (55)  order by isa.id desc");
										if(rs9122.first()){
											Unit_62GM_GurrChana = rs9122.getDouble(1);
										}
										
										ResultSet rs91221=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (56)  order by isa.id desc");
										if(rs91221.first()){
											Unit_Jar_GurrChana = rs91221.getDouble(1);
										}
										
										ResultSet rs91222=s2.executeQuery("SELECT sum(total_units) FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id in (57)  order by isa.id desc");
										if(rs91222.first()){
											Unit_400G_SugarSMP = rs91222.getDouble(1);
										}
										...
										String RawCases140G="";
										int UnitPerSKUSugar_800Gm =0;
										String RawCases800Gm="";
										...
										ResultSet rs300=s2.executeQuery("SELECT sum(total_units), ipv.unit_per_sku FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=59 order by isa.id desc");
										if(rs300.first()){
											Sugar_800Gm = rs300.getLong(1);
											UnitPerSKUSugar_800Gm = rs300.getInt(2);
											TotalUnitPerSKU800GM=UnitPerSKUSugar_800Gm;
										}
										RawCases800Gm = Utilities.convertToRawCases(Sugar_800Gm, UnitPerSKUSugar_800Gm);
										...
										ResultSet rs3231=s2.executeQuery("SELECT sum(total_units), ipv.unit_per_sku FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=58 order by isa.id desc");
										if(rs3231.first()){
											Unit_500G_ShakkarPack = rs3231.getLong(1);																				
										}
										...
										ResultSet rs334=s2.executeQuery("SELECT sum(total_units), ipv.unit_per_sku FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=32 order by isa.id desc");
										if(rs334.first()){
											Unit_510G_Gur = rs334.getDouble(1);																				
										}
										ResultSet rs335=s2.executeQuery("SELECT sum(total_units/10), ipv.unit_per_sku FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=33 order by isa.id desc");
										if(rs335.first()){
											Unit_100G_Shakkar = rs335.getLong(1);																				
										}
										ResultSet rs336=s2.executeQuery("SELECT sum(total_units), ipv.unit_per_sku FROM pep.inventory_sales_adjusted isa join inventory_sales_adjusted_products isap on isa.id=isap.id join inventory_products_view ipv on ipv.product_id=isap.product_id where isa.created_on between "+Utilities.getSQLDate(CurrentDate)+" and "+Utilities.getSQLDateNext(CurrentDate)+" and isa.outlet_id="+OutletID+" and isap.product_id=34 order by isa.id desc");
										if(rs336.first()){
											Unit_200G_Shakkar = rs336.getLong(1);																				
										}
										...
										ConvertedUnit_Unit_500G_ShakkarPack=Unit_500G_ShakkarPack;
										...
										ConvertedUnit_Box_1005G_Fennel_Gur=Unit_Box_1005G_Fennel_Gur;
										 ...
										 ConvertedUnit510GGur=Unit_510G_Gur;
										 ConvertedUnit_Unit_100G_Shakkar=Unit_100G_Shakkar;
										 ConvertedUnit_Unit_200G_Shakkar=Unit_200G_Shakkar;
										
										//closed
		
										//NEw SKU added on 22-12-22
										Converted_240G_Original=Unit_240G_Original;
										Converted_240G_Fennel=Unit_240G_Fennel;
										Converted_240G_Coconut=Unit_240G_Coconut;
										Converted_240G_Ginger=Unit_240G_Ginger;
										Converted_240G_Orange=Unit_240G_Orange;
										Converted_240G_Pan=Unit_240G_Pan;
										Converted_240G_Strawberry=Unit_240G_Strawberry;
										Converted_240G_Ajwain=Unit_240G_Ajwain;
										
										Converted_60G_SugarSMP=Unit_60G_SugarSMP;
										Converted_120G_SugarSMP=Unit_120G_SugarSMP;
										
										Converted_360G_Original=Unit_360G_Original;
										Converted_360G_Fennel=Unit_360G_Fennel;
										Converted_360G_Orange=Unit_360G_Orange;
										Converted_360G_Ginger=Unit_360G_Ginger;
										Converted_360G_Coconut=Unit_360G_Coconut;
										Converted_360G_Pan=Unit_360G_Pan;
										Converted_360G_Strawberry=Unit_360G_Strawberry;
										Converted_360G_Ajwain=Unit_360G_Ajwain;
										
										Converted_408GM_GurrBox=Unit_408GM_GurrBox;
										
										Converted_30GM_GurrChana=Unit_30GM_GurrChana;
										Converted_62GM_GurrChana=Unit_62GM_GurrChana;
										Converted_Jar_GurrChana=Unit_Jar_GurrChana;
										
										Converted_400G_SugarSMP=Unit_400G_SugarSMP;
										
										
										Converted = ConvertedUnits500GM+ ConvertedUnits500GM1+ _Ramzan450G_Gur+ConvertedUnit_Ramzan300G_Gur+ConvertedUnit_EID_GIFT_PACK+ConvertedUnit_Unit_500G_Shakkar+ConvertedUnit_Jar_300_Fennel_Gur+ConvertedUnit_450G_Fennel_Gurr+ConvertedUnit_Box_1005G_Fennel_Gur+ConvertedWrappedGurrJarOrange+ConvertedWrappedGurrJarGinger+ConvertedWrappedGurrJarCoconut+ConvertedGurBox450Orange+ConvertedGurBox450Ginger+ConvertedGurBox450Coconut+ConvertedGurBox425G+ConvertedUnit510GGur+ConvertedUnit_Unit_100G_Shakkar+ConvertedUnit_Unit_200G_Shakkar+Converted_240G_Original+Converted_240G_Fennel+Converted_240G_Coconut+Converted_240G_Ginger+Converted_240G_Orange+Converted_240G_Pan+Converted_240G_Strawberry+Converted_240G_Ajwain+Converted_60G_SugarSMP+Converted_120G_SugarSMP+Converted_360G_Original+Converted_360G_Fennel+Converted_360G_Orange+Converted_360G_Ginger+Converted_360G_Coconut+Converted_360G_Pan+Converted_360G_Strawberry+Converted_360G_Ajwain+Converted_408GM_GurrBox+Converted_30GM_GurrChana+Converted_62GM_GurrChana+Converted_Jar_GurrChana+Converted_400G_SugarSMP+ConvertedUnit_Unit_500G_ShakkarPack;											
									...
									TotalArray[29]+=Unit_510G_Gur;
									TotalArray[30]+=Unit_100G_Shakkar;
									TotalArray[31]+=Unit_200G_Shakkar;
									
								
									TotalArray[32]+=Unit_240G_Original;
									TotalArray[33]+=Unit_240G_Fennel;
									TotalArray[34]+=Unit_240G_Coconut;
									TotalArray[35]+=Unit_240G_Ginger;
									TotalArray[36]+=Unit_240G_Orange;
									TotalArray[37]+=Unit_240G_Pan;
									TotalArray[38]+=Unit_240G_Strawberry;
									TotalArray[39]+=Unit_240G_Ajwain;
									TotalArray[40]+=Unit_60G_SugarSMP;
									TotalArray[41]+=Unit_120G_SugarSMP;
									TotalArray[42]+=Unit_360G_Original;
									TotalArray[43]+=Unit_360G_Fennel;
									TotalArray[44]+=Unit_360G_Orange;
									TotalArray[45]+=Unit_360G_Ginger;
									TotalArray[46]+=Unit_360G_Coconut;
									TotalArray[47]+=Unit_360G_Pan;
									TotalArray[48]+=Unit_360G_Strawberry;
									TotalArray[49]+=Unit_360G_Ajwain;
									TotalArray[50]+=Unit_408GM_GurrBox;
									TotalArray[51]+=Unit_30GM_GurrChana;
									TotalArray[52]+=Unit_62GM_GurrChana;
									TotalArray[53]+=Unit_Jar_GurrChana;
									TotalArray[54]+=Unit_400G_SugarSMP;
									TotalArray[55]+=Unit_500G_Shakkar;
									
									TotalArray[56]+=Converted;
									TotalArray[57]+=TotalAmount;
									
									
									
									
									if(Units_500G!=0 || Units_250G!=0 || Units_25G!=0 || Units_500G1!=0 || Units_250G1!=0 || Units_500G2!=0 || Units_250G2!=0 ||  Units_250G3!=0 || Units_250G4!=0 || Units_1KG != 0 || Units_2KG !=0 || Units_5KG !=0 || Unit_Jar_Gur!=0 || Unit_Box_Gur!=0 || Units_70G!=0 || Units_140G!=0 || Unit_Box450G_Gur!=0 || Unit_Ramzan450G_Gur!=0 || Unit_Ramzan300G_Gur!=0 || Unit_500G_Shakkar!=0 || Unit_500G_ShakkarPack!=0 || EID_GIFT_PACK!=0 || Unit_Jar_300_Fennel_Gur!=0 || Unit_Box_450G_Fennel_Gur!=0 || Unit_Box_1005G_Fennel_Gur!=0 || WrappedGurrJarOrange!=0 || WrappedGurrJarGinger!=0 || WrappedGurrJarCoconut!=0 || GurBox450Orange!=0 || GurBox450Ginger!=0 || GurBox450Coconut!=0 || GurBox425G!=0 || Unit_510G_Gur!=0 || Unit_100G_Shakkar!=0 || Unit_200G_Shakkar!=0 || Unit_240G_Original!=0 || Unit_240G_Fennel!=0 || Unit_240G_Coconut!=0 || Unit_240G_Ginger!=0 || Unit_240G_Orange!=0 || Unit_240G_Pan!=0 || Unit_240G_Strawberry!=0 || Unit_240G_Ajwain!=0 || Unit_60G_SugarSMP!=0 || Unit_120G_SugarSMP!=0 || Unit_360G_Original!=0 || Unit_360G_Fennel!=0 || Unit_360G_Orange!=0 || Unit_360G_Ginger!=0 || Unit_360G_Coconut!=0 || Unit_360G_Pan!=0 || Unit_360G_Strawberry!=0 || Unit_360G_Ajwain!=0 || Unit_408GM_GurrBox!=0 || Unit_30GM_GurrChana!=0 || Unit_62GM_GurrChana!=0 || Unit_Jar_GurrChana!=0 || Unit_400G_SugarSMP!=0){
										...
										<tr style="font-size:11px;background-color:#E8E8E8">
											<td Style="color:#E8E8E8" colspan="63"></td>
										</tr>
										<tr style="font-size:11px;">
											...
											<td style="text-align:center;"><%if(Sugar_800Gm!=0){%><%=RawCases800Gm %><%} %></td>
											...
											<td style="text-align:center;"><%if(Unit_510G_Gur!=0){%><%=Unit_510G_Gur %><%} %></td>
											<td style="text-align:center;"><%if(Unit_100G_Shakkar!=0){%><%=Unit_100G_Shakkar %><%} %></td>
											<td style="text-align:center;"><%if(Unit_200G_Shakkar!=0){%><%=Unit_200G_Shakkar %><%} %></td>
								

											<td style="text-align:center;"><%if(Unit_240G_Original!=0){%><%=Unit_240G_Original %><%} %></td>
											<td style="text-align:center;"><%if(Unit_240G_Fennel!=0){%><%=Unit_240G_Fennel %><%} %></td>
											<td style="text-align:center;"><%if(Unit_240G_Coconut!=0){%><%=Unit_240G_Coconut %><%} %></td>
											<td style="text-align:center;"><%if(Unit_240G_Ginger!=0){%><%=Unit_240G_Ginger %><%} %></td>
											<td style="text-align:center;"><%if(Unit_240G_Orange!=0){%><%=Unit_240G_Orange %><%} %></td>
											<td style="text-align:center;"><%if(Unit_240G_Pan!=0){%><%=Unit_240G_Pan %><%} %></td>
											<td style="text-align:center;"><%if(Unit_240G_Strawberry!=0){%><%=Unit_240G_Strawberry %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Ajwain!=0){%><%=Unit_360G_Ajwain %><%} %></td>
											<td style="text-align:center;"><%if(Unit_60G_SugarSMP!=0){%><%=Unit_60G_SugarSMP %><%} %></td>
											<td style="text-align:center;"><%if(Unit_120G_SugarSMP!=0){%><%=Unit_120G_SugarSMP %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Original!=0){%><%=Unit_360G_Original %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Fennel!=0){%><%=Unit_360G_Fennel %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Orange!=0){%><%=Unit_360G_Orange %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Ginger!=0){%><%=Unit_360G_Ginger %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Coconut!=0){%><%=Unit_360G_Coconut %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Pan!=0){%><%=Unit_360G_Pan %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Strawberry!=0){%><%=Unit_360G_Strawberry %><%} %></td>
											<td style="text-align:center;"><%if(Unit_360G_Ajwain!=0){%><%=Unit_360G_Ajwain %><%} %></td>
											<td style="text-align:center;"><%if(Unit_408GM_GurrBox!=0){%><%=Unit_408GM_GurrBox %><%} %></td>
											<td style="text-align:center;"><%if(Unit_30GM_GurrChana!=0){%><%=Unit_30GM_GurrChana %><%} %></td>
											<td style="text-align:center;"><%if(Unit_62GM_GurrChana!=0){%><%=Unit_62GM_GurrChana %><%} %></td>
											<td style="text-align:center;"><%if(Unit_Jar_GurrChana!=0){%><%=Unit_Jar_GurrChana %><%} %></td>
											<td style="text-align:center;"><%if(Unit_400G_SugarSMP!=0){%><%=Unit_400G_SugarSMP %><%} %></td>
											<td style="text-align:center;"><%if(Unit_500G_ShakkarPack!=0){%><%=Unit_500G_ShakkarPack %><%} %></td>
