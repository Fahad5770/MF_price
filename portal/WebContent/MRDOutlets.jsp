...
<script src="js/MRDOutlets.js"></script>
<script src="js/lookups.js"></script>
...
%>
<div data-role="page" id="MRDOutletsFormPage" data-url="MRDOutletsFormPage" data-theme="d">

	
	<jsp:include page="Header2.jsp" >
    	<jsp:param value="MRD Outlets" name="title"/>
    </jsp:include>
	 
    <div data-role="content" data-theme="d">
    	<form id="MRDOutletsForm" name="MRDOutletsForm" action="#" method="POST" data-ajax="false">
			...
			<table style="width:100%; border-collapse:collapse;" border="0" >
	        	<tr>
	        		...
	        		<td>
	        			...
	        			<input type="text" name="Address" id="Address" value="" areadonly="readonly" >
	        		</td>
	        		<td>
    ...
    <div data-role="footer" data-position="fixed" data-theme="b" id="WorkflowRouteFooter">
		<div>			
			...
			<button data-icon="check" data-theme="b" data-inline="true" onClick="window.location='MRDOutlets.jsp'">Reset</button>
