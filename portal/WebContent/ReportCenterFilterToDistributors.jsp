...
<script>
        ...
        <fieldset data-role="controlgroup" data-corners="true" style="margin-left: 0px; margin-top: -10px; padding-top: 0px;">
           ...
           if (session.getAttribute(UniqueVoID+"_SR1SelectedToDistributors") != null){
           	SelectedPackagesArray = (long[])session.getAttribute(UniqueVoID+"_SR1SelectedToDistributors");           	
           }
           ...
           //for(int x=0;x<UserDistributor.length;x++){
        	   ...
        	   if (session.getAttribute(UniqueVoID+"_SR1SelectedToDistributors") != null){
            	...
            	%>    		
           			<input type="checkbox" name="ToDistributorCheckBox" id="DistributorID_<%=DistributorID %>" value="<%=DistributorID %>" <%if(CheckBoxSelected){ %>checked<%} %> onClick="ChangeToLabelDistributor('<%=ClickIDD%>')" data-mini="true">
            	...
            	while(rs2.next()){
            		...
            		%>
           			<input type="checkbox" name="ToDistributorCheckBox" id="DistributorID_<%=rs2.getLong(1) %>" value="<%=rs2.getLong(1) %>" <%if(CheckBoxSelected){ %>checked<%} %> onClick="ChangeToLabelDistributor('<%=ClickIDD%>')" data-mini="true">
