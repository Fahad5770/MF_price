...
if(Utilities.isAuthorized(273, SessionUserID) == false){
...
<head>
        ...
        <script src="js/PrimarySalesOrder.js?221111111111=221111111111"></script>
...
<div data-role="page" id="DeskSale" data-url="DeskSale" data-theme="d">
     ...
     <jsp:include page="Header2.jsp" >
    	<jsp:param value="Primary Sales" name="title"/>
    </jsp:include>
	...
	<table border="0" style="width: 100%">
		...
		<tr>
			<td style="width: 15%;" >
				<input type="text" placeholder="Distributor ID" id="DeskSaleDistributorID" name="DeskSaleDistributorID" data-mini="true" onChange="getDistributorName12(); "  maxlength="10">
			</td>
			<td style="width: 20%;">
    ...
    <table style="width:100%;">
		<tr>
			...
			<td valign="top" style="width:10%">
				<input type="text" placeholder="Product Code" id="DeskSaleProductCode" name="DeskSaleProductCode" data-mini="true"  onchange="setRowEmpty();setRate();"  >
			</td>
			<td valign="top" style="width:10%">
			...
			<tr>
				<td>
                   ...
                   <!--   <a data-icon="check" data-theme="b" data-role="button" data-inline="true" id="DeskSalePrint" href="DeskSalePrint.jsp?DeliveryID=<% if( isEditCase ){ out.print(EditID); }else if( isPrintCase ){ out.print(DeskSaleIDPrint); } %>" target="_blank" <% if( isEditCase == false && isPrintCase == false ){ %> class="ui-disabled" <% } %>  >Print</a> -->
                    ...
                    <button data-icon="check" data-theme="b" data-inline="true" id="DeskSaleReset" onClick="javascript:window.location='PrimarySalesOrder.jsp'" >Reset</button>
                    <% if( isEditCase ) { %>
