...
<script type="text/javascript">
	...
	if(PjpID == "x125"){
		var url = 'ReportCenterR210PJPOutletSummary.jsp?PJPID=x125&UniqueSessionID=<%=UniqueSessionID%>';
	}	
	
	var url = 'ReportCenterR210PJPOutletSummary.jsp?PJPID='+PjpID+'&UniqueSessionID=<%=UniqueSessionID%>';
			...
			<ul data-role="listview" data-inset="true" class="ui-icon-alt" data-theme="d" data-divider-theme="c" data-count-theme="c" style="margin-top:-13px;">
				...
				while(rs22.next()){
					...
					<li style="height: 35px" >
						<a data-ajax="false" id="PJPLi_<%=rs22.getString("id")%>" href="javascript: LoadPJPOutletReport(<%=rs22.getString("id")%>)" style="font-size:11px; font-weight:normal;"><%=rs22.getString("id")+" - "+rs22.getString("label")%><span class="ui-li-count" style="font-size:10px"><%=rs22.getString("outlet_count")%></span></a>
					</li>
					<%
