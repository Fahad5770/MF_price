...
<head>
		...
		<script src="js/GLUnpostOrder.js?99=99"></script>
...
<div data-role="page" id="GLUnpostOrderPage" data-url="GLUnpostOrderPage" data-theme="d">

    <jsp:include page="Header3.jsp" >
    	<jsp:param value="Unpost Order" name="title"/>
	...
	<div class="ui-grid-a" >
	    <div class="ui-block-a" style="width:75%">
	    	<div class="ui-bar " style="min-height:60px">
				...
				<form name="UnpostOrderExecute" id="UnpostOrderExecute" action="#" method="post" >
    ...
    <div data-role="footer" data-position="fixed" data-theme="b">
		<div>
			<table style="width: 100%;">
				<tr>
					<td>
						<a data-icon="check" data-theme="a" data-role="button" data-inline="true" id="SubmitButton" href="#" onClick="FormSubmit();" aclass="ui-disabled" >Unpost</a>
						<button data-icon="check" data-theme="b" data-inline="true" onClick="javascript:window.location='GLUnpostOrder.jsp'" >Reset</button>
					</td>
