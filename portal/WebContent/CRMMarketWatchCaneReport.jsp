...
<script type="text/javascript">
	...
	function OpenMarketWatchCaneForm(WatchID){ 
		
		//alert("OrderBookerGetOrderActivityReport Function");
		var url = 'CRMMarketWatchCaneForm.jsp?WatchID='+WatchID+'&UniqueSessionID=<%=UniqueSessionID%>';
	...
	function PoplulateTasks(){
		...
		$.get("CRMMarketWatchCaneList.jsp?&UniqueSessionID=<%=UniqueSessionID%>", function(data) {
			  $.mobile.hidePageLoadingMsg();
			  $("#TasksDIV").html(data); 
