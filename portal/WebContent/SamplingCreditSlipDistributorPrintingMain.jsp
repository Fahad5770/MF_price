...
<div data-role="page" id="SamplingPrintingMain" data-url="SamplingPrintingMain" data-theme="d">
    ...
    <jsp:include page="Header2.jsp" >
    	<jsp:param value="Credit Slip Distributor Printing" name="title"/>
    </jsp:include>
    
    <div data-role="content" data-theme="d">

	<form id="CreditSlipPrintingGenerateForm" name="CreditSlipPrintingGenerateForm" action="SamplingCreditSlipDistributorPrinting.jsp" method="POST" data-ajax="false" target="_blank">
