...
<script>
        ...
        ResultSet rs = s.executeQuery("select * from employee_view where sap_code in (select distinct dbpv.assigned_to from distributor_beat_plan_users dbpv  where id in( select id from distributor_beat_plan where distributor_id in ("+DistributorIds+")))");
