...
<script type="text/javascript">
	...
	function OpenComplaintForm(ComplaintID, IsVerified){
		...
		var url = 'CRMComplaintVerificationForm.jsp?ComplaintID='+ComplaintID+'&IsVerified='+IsVerified+'&UniqueSessionID=<%=UniqueSessionID%>';
			...
			<ul data-role="listview" data-inset="true" class="ui-icon-alt" data-theme="d" data-divider-theme="c" data-count-theme="c" style="margin-top:-13px;">
				...
				<!-- 
					...
					<fieldset data-role="controlgroup"  style="margin-top:-13px;">
					     	...
					     	<label for="radio-choice-1">Not Verified</label>
					     	...
					     	<label for="radio-choice-2">Verified</label>
